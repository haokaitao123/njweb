...
<template>
  <div class="wrap">
      <div class="top">
        ...
        <span class="ImageRl" @click="complete">完成</span>
      </div>
      <div class="wrapAll">
      <div class="theme">
        <div class="subject">
      ...
      <div class="dateLast">
        ...
        <!--<div>-->
          <!--&lt;!&ndash;<span><img src="../../../.././static/date/wd_13.png" alt=""></span>&ndash;&gt;-->
          <!--<span>描述</span>-->
        <!--</div>-->
      </div>
    ...
    <invitePeople v-if="this.$store.state.dateList.EdinvitTime"></invitePeople>
  </div>
</template>
<script>
...
//          remindRepeatweek:this.date_List.remindRepeatweek.join(','),
        ...
        console.log(this.date_List.remindRepeatweek)
...
//          console.log(res)
          ...
          this.$store.commit('dateList/setpeoRows', 10)
...
//            console.log(t.$store.state.InviteName)
            ...
            this.date_List.remindRepeatstop = this.dataList.remindRepeatstop
...
//        this.$store.state.InviteCount = []
        alert(1)
        this.$store.commit('dateList/setEdinvitTime', true)
      },
      selectDateStart() {
        const t = this
