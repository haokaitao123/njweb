<template>
  <div>
    <div v-loading="isLoading" class="message"></div>
    <div class="message">
      <div>
        <!-- 下拉框 -->
        <span>离职类型</span>
    ...
    <div class="message">
      <div class="msgOne">
        <div>最后工作日期</div>
        <div>
          <span>{{empdimLaskworkdayTime}}</span>
    ...
    <div class="message">
      <div class="msgOne">
        ...
        <div>最后雇用日期</div>
        <div>
          <span>{{empdimLaskemploydayTime}}</span>
    ...
    <dateYear @close="closeDate" :iswork="iswork" :empFlowDimission="empFlowDimission" v-show="dateYear"></dateYear>
  ...
  export default {
    ...
    data() {
      return {
        ...
        isCertificate: '1',
        startDate: new Date(),
        empdimLaskworkdayTime:this.empFlowDimission.empdimLaskworkday,
        empdimLaskemploydayTime: this.empFlowDimission.empdimLaskemployday,
      }
    },
    components:{
      dateYear,
...
//        this.dateYear = true
      ...
      handleConfirm (data) {
        ...
        if (this.iswork === 0) {
          this.empFlowDimission.empdimLaskworkday = date
          this.empdimLaskworkdayTime = date
        } else {
          this.empFlowDimission.empdimLaskemployday = date
          this.empdimLaskemploydayTime = date
        }
//        alert(date)
      },
      closeDate() {
