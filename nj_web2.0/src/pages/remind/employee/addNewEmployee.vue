<template>
  <div class="cover">
      ...
      <Row>
        <Col span="5" style>
          <div class="headImg">
            <div class="header-box">
              <div class="header-cover" @click="render1">点击上传头像</div>
              <div class="header" style>
                <img
                  :src="cropedImg===''?'../../../static/img/header1.png':cropedImg"
                  width="150"
                  height="150"
                >
              </div>
            ...
            <Menu active-name="baseInfo" width="auto">
              ...
              <MenuItem name="companyInfo">
                <a
                  href="#companyInfo"
                  @click="newColor(this)"
                >{{$t('lang_employee.empmaster.title2')}}</a>
              </MenuItem>
        ...
        <Col span="19" style="background: #FFFFFF;">
          <Row>
            ...
            <div
              style="margin-top: 80px;padding-left: 25px;max-height: 410px;overflow-y: auto;margin-right: 10px;margin-bottom: 20px;"
            >
              <Form
                ref="formEmpValidate"
                :rules="ruleValidate"
              ...
              >
                <a name="baseInfo">
                  <Icon type="compose" size="15" style="margin-right: 5px;"></Icon>
                  {{$t('lang_employee.baseInfo.title')}}
                </a>
                <Row>
                  <Col span="23">
                    <FormItem :label="$t('lang_employee.baseInfo.baseGid')" prop="baseGid">
                      <Input
                        :placeholder="$t('lang_employee.baseInfo.baseGidDis')"
                        v-model="formEmpValidate.baseGid"
                      />
                    </FormItem>
                  </Col>
                </Row>
                ...
                <Row>
                  <Col span="11">
                    <FormItem :label="$t('lang_employee.baseInfo.baseCname')" prop="baseCname">
                      <Input
                        :placeholder="$t('lang_employee.baseInfo.baseCnameDis')"
                  ...
                  <Col span="11" offset="1">
                    <FormItem :label="$t('lang_employee.baseInfo.baseAlias')" prop="baseAlias">
                      <Input
                        :placeholder="$t('lang_employee.baseInfo.baseAliasDis')"
                        v-model="formEmpValidate.baseAlias"
                      />
                    </FormItem>
                  </Col>
                </Row>
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.baseInfo.baseLastname')"
                      prop="baseLastname"
                    >
                      <Input
                        :placeholder="$t('lang_employee.baseInfo.baseLastnameDis')"
                        v-model="formEmpValidate.baseLastname"
                      />
                    </FormItem>
                  </Col>
                  <Col span="11" offset="1">
                    <FormItem
                      :label="$t('lang_employee.baseInfo.baseFirstname')"
                      prop="baseFirstname"
                    >
                      <Input
                        :placeholder="$t('lang_employee.baseInfo.baseFirstnameDis')"
                        v-model="formEmpValidate.baseFirstname"
                      />
                    </FormItem>
                  </Col>
                </Row>
                ...
                <Row>
                  ...
                  <Col span="11" offset="1">
                    <FormItem :label="$t('lang_employee.baseInfo.idsNo')" prop="idsNo">
                      <Input
                        :placeholder="$t('lang_employee.baseInfo.idsNoDis')"
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.baseInfo.baseBirthdate')"
                      prop="baseBirthdate"
                    >
                      <DatePicker
                        type="date"
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.baseInfo.baseMarriage')"
                      prop="baseMarriage"
                    >
                  ...
                  <Col span="11" offset="1">
                    <FormItem :label="$t('lang_employee.baseInfo.baseNation')" prop="baseNation">
                      <span @dblclick="dbNation">
                        <Input
                          :placeholder="$t('lang_employee.baseInfo.baseNationDis')"
                          icon="search"
                          :readonly="true"
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.baseInfo.basePolitical')"
                      prop="basePolitical"
                    >
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.baseInfo.baseTechnicaltitle')"
                      prop="baseTechnicaltitle"
                    >
                  ...
                  <Col span="11" offset="1">
                    <FormItem
                      :label="$t('lang_employee.baseInfo.baseTechspec')"
                      prop="baseTechspec"
                    >
                      <Input
                        :placeholder="$t('lang_employee.baseInfo.baseTechspecDis')"
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.baseInfo.baseFirstworkdate')"
                  ...
                  <Col span="11" offset="1">
                    <FormItem
                      :label="$t('lang_employee.baseInfo.baseTechdate')"
                      prop="baseTechdate"
                    >
                      <DatePicker
                        type="date"
                ...
                <a name="companyInfo">
                  <Icon type="compose" size="15" style="margin-right: 5px;"></Icon>
                  {{$t('lang_employee.companyInfo.title')}}
                </a>
                <Row>
                  <Col span="11">
                    <FormItem :label="$t('lang_employee.companyInfo.pkiWorkno')" prop="pkiWorkno">
                      <Input
                        :placeholder="$t('lang_employee.companyInfo.pkiWorknoDis')"
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.companyInfo.compHirecompany')"
                      prop="compHirecompany"
                    >
                      <span @dblclick="dbHCompany">
                        <Input
                          :placeholder="$t('lang_employee.companyInfo.compHirecompanyDis')"
                          icon="search"
                          :readonly="true"
                  ...
                  <Col span="11" offset="1">
                    <FormItem :label="$t('lang_employee.companyInfo.compDept')" prop="compDept">
                      <span @dblclick="dbDept">
                        <Input
                          :placeholder="$t('lang_employee.companyInfo.compDeptDis')"
                          icon="search"
                          :readonly="true"
                ...
                <Row>
                  <Col span="11">
                    <FormItem :label="$t('lang_employee.companyInfo.compPost')" prop="compPost">
                      <span @dblclick="dbPost">
                        <Input
                          :placeholder="$t('lang_employee.companyInfo.compPostDis')"
                          icon="search"
                          :readonly="true"
                  ...
                  <Col span="11" offset="1">
                    <FormItem
                      :label="$t('lang_employee.companyInfo.compCostcenter')"
                      prop="compCostcenter"
                    >
                      <span @dblclick="dbCostcenter">
                        <Input
                          :placeholder="$t('lang_employee.companyInfo.compCostcenterDis')"
                          icon="search"
                          :readonly="true"
                          v-model="formEmpValidate.compCostcenter"
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.companyInfo.compHirelocation')"
                      prop="compHirelocation"
                    >
                      <span @dblclick="dbHirelocation">
                        <Input
                          :placeholder="$t('lang_employee.companyInfo.compHirelocationDis')"
                          icon="search"
                          :readonly="true"
                  ...
                  <Col span="11" offset="1">
                    <FormItem
                      :label="$t('lang_employee.companyInfo.compWorklocation')"
                      prop="compWorklocation"
                    >
                      <span @dblclick="dbWorklocation">
                        <Input
                          :placeholder="$t('lang_employee.companyInfo.compWorklocationDis')"
                          icon="search"
                          :readonly="true"
                  ...
                  <Col span="11">
                    <FormItem :label="$t('lang_employee.companyInfo.compBuspmp')" prop="compBuspmp">
                      <span @dblclick="dbBuspmp">
                        <Input
                          :placeholder="$t('lang_employee.companyInfo.compBuspmpDis')"
                          icon="search"
                          :readonly="true"
                  ...
                  <Col span="11" offset="1">
                    <FormItem :label="$t('lang_employee.companyInfo.compFunpmp')" prop="compFunpmp">
                      <span @dblclick="dbFunpmp">
                        <Input
                          :placeholder="$t('lang_employee.companyInfo.compFunpmpDis')"
                          icon="search"
                          :readonly="true"
                          v-model="formEmpValidate.compFunpmp"
                          @on-click="selectFunpmp($t('lang_employee.searchTableTitle.gManger'))"
                        />
                      </span>
                    </FormItem>
                  </Col>
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.companyInfo.compEntrydate')"
                      prop="compEntrydate"
                    >
                      <DatePicker
                        type="date"
                  ...
                  <Col span="11" offset="1">
                    <FormItem
                      :label="$t('lang_employee.companyInfo.compServicedate')"
                      prop="compServicedate"
                    >
                      <DatePicker
                        type="date"
                        :placeholder="$t('lang_employee.companyInfo.compServicedateDis')"
                        v-model="formEmpValidate.compServicedate"
                        style="width: 100%"
                      ></DatePicker>
                    </FormItem>
                  </Col>
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.companyInfo.compCertificatedate')"
                      prop="compCertificatedate"
                    >
                      <DatePicker
                        type="date"
                        :placeholder="$t('lang_employee.companyInfo.compCertificatedateDis')"
                        v-model="formEmpValidate.compCertificatedate"
                        style="width: 100%"
                      ></DatePicker>
                    </FormItem>
                  </Col>
                  <Col span="11" offset="1">
                    <FormItem :label="$t('lang_employee.companyInfo.compHr')" prop="compHr">
                      <span @dblclick="dbCompHR">
                        <Input
                          :placeholder="$t('lang_employee.companyInfo.compHrDis')"
                          v-model="formEmpValidate.compHr"
                          icon="search"
                          :readonly="true"
                          @on-click="selectCompHR($t('lang_employee.searchTableTitle.compHR'))"
                        />
                      </span>
                    </FormItem>
                  </Col>
                ...
                <a name="contractInfo">
                  <Icon type="compose" size="15" style="margin-right: 5px;"></Icon>
                  {{$t('lang_employee.contractInfo.title')}}
                </a>
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.contractInfo.ctContracttype')"
                      prop="ctContracttype"
                    >
                  ...
                  <Col span="11" offset="1">
                    <FormItem
                      :label="$t('lang_employee.contractInfo.ctContractperiod')"
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.contractInfo.ctContractsdate')"
                  ...
                  <Col span="11" offset="1">
                    <FormItem
                      :label="$t('lang_employee.contractInfo.ctContractedate')"
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.contractInfo.ctContractprom')"
                      prop="ctContractprom"
                    >
                  ...
                  <Col span="11" offset="1">
                    <FormItem
                      :label="$t('lang_employee.contractInfo.ctConfidential')"
                      prop="ctConfidential"
                    >
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.contractInfo.ctContractworktime')"
                  ...
                  <Col span="11" offset="1">
                    <FormItem
                      :label="$t('lang_employee.contractInfo.ctSigndate')"
                      prop="ctSigndate"
                    >
                      <DatePicker
                        type="date"
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.contractInfo.ctProbation')"
                      prop="ctProbation"
                    >
                  ...
                  <Col span="11" offset="1">
                    <FormItem
                      :label="$t('lang_employee.contractInfo.ctProbationdate')"
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.contractInfo.ctProbationprom')"
                ...
                <Row>
                  <Col span="11">
                    <FormItem :label="$t('lang_employee.payInfo.salPostlevel')" prop="salPostlevel">
                      <Select v-model="formEmpValidate.salPostlevel">
                        <Option
                          :value="item.paramCode"
                          v-for="(item,index) in selectPostlevel"
                          :key="index"
                        >{{item.paramInfoCn}}</Option>
                      </Select>
                    </FormItem>
                  ...
                  <Col span="11" offset="1">
                    <FormItem
                      :label="$t('lang_employee.payInfo.salSalarylevel')"
                      prop="salSalarylevel"
                    >
                      <Select v-model="formEmpValidate.salSalarylevel">
                        <Option
                          :value="item.paramCode"
                          v-for="(item,index) in selectSalarylevel"
                          :key="index"
                        >{{item.paramInfoCn}}</Option>
                      </Select>
                    </FormItem>
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.payInfo.salTravellevel')"
                      prop="salTravellevel"
                    >
                      <Select v-model="formEmpValidate.salTravellevel">
                        <Option
                          :value="item.paramCode"
                          v-for="(item,index) in selectTravellevel"
                          :key="index"
                        >{{item.paramInfoCn}}</Option>
                      </Select>
                    </FormItem>
                  ...
                  <Col span="11" offset="1">
                    <FormItem
                      :label="$t('lang_employee.payInfo.salAdminlevel')"
                      prop="salAdminlevel"
                    >
                      <Select v-model="formEmpValidate.salAdminlevel">
                        <Option
                          :value="item.paramCode"
                          v-for="(item,index) in selectAdminlevel"
                          :key="index"
                        >{{item.paramInfoCn}}</Option>
                      </Select>
                    </FormItem>
                  ...
                  <Col span="11">
                    <FormItem :label="$t('lang_employee.payInfo.salSalaryset')" prop="salSalaryset">
                      <Select v-model="formEmpValidate.salSalaryset">
                        <Option
                          :value="item.id"
                          v-for="(item,index) in selectSalaryset"
                          :key="index"
                        >{{item.payssCN}}</Option>
                      </Select>
                    </FormItem>
                  ...
                  <Col span="11" offset="1">
                    <FormItem :label="$t('lang_employee.payInfo.bkBank')" prop="bkBank">
                      <span @dblclick="dbbkBank">
                        <Input
                          :placeholder="$t('lang_employee.payInfo.bkBankDis')"
                          icon="search"
                          :readonly="true"
                          v-model="formEmpValidate.bkBank"
                          @on-click="selectBank"
                        />
                      </span>
                    </FormItem>
                ...
                <Row>
                  <Col span="11">
                    <FormItem :label="$t('lang_employee.payInfo.bkAccount')" prop="bkAccount">
                      <Input
                        :placeholder="$t('lang_employee.payInfo.bkAccountDis')"
                        v-model="formEmpValidate.bkAccount"
                      />
                    </FormItem>
                  </Col>
                  <Col span="11" offset="1">
                    <FormItem :label="$t('lang_employee.payInfo.bkAccnane')" prop="bkAccnane">
                      <Input
                        :placeholder="$t('lang_employee.payInfo.bkAccnaneDis')"
                        v-model="formEmpValidate.bkAccnane"
                      />
                    </FormItem>
                  </Col>
                </Row>
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.payInfo.sbBenefitlocation')"
                      prop="sbBenefitlocation"
                    >
                      <span @dblclick="dbsbBenefitlocation">
                        <Input
                          :placeholder="$t('lang_employee.payInfo.sbBenefitlocationDis')"
                          icon="search"
                          :readonly="true"
                          v-model="formEmpValidate.sbBenefitlocation"
                          @on-click="selectBenefitlocation($t('lang_employee.searchTableTitle.benefitlocation'))"
                        />
                      </span>
                    </FormItem>
                  </Col>
                  <Col span="11" offset="1">
                    <FormItem
                      :label="$t('lang_employee.payInfo.sbBenefitpolicy')"
                      prop="sbBenefitpolicy"
                    >
                      <span @dblclick="dbsbBenefitpolicy">
                        <Input
                          :placeholder="$t('lang_employee.payInfo.sbBenefitpolicyDis')"
                          icon="search"
                          :readonly="true"
                          v-model="formEmpValidate.sbBenefitpolicy"
                          @on-click="selectBenefitpolicy($t('lang_employee.searchTableTitle.benefitpolicy'), '1')"
                        />
                      </span>
                    </FormItem>
                  </Col>
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.payInfo.sbBenefittype')"
                      prop="sbBenefittype"
                    >
                      <Select v-model="formEmpValidate.sbBenefittype">
                        <Option
                          :value="item.paramCode"
                          v-for="(item,index) in selectsbBenefittype"
                          :key="index"
                        >{{item.paramInfoCn}}</Option>
                      </Select>
                    </FormItem>
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.payInfo.sbHfundlocatio')"
                      prop="sbHfundlocatio"
                    >
                      <span @dblclick="dbsbHfundlocatio">
                        <Input
                          :placeholder="$t('lang_employee.payInfo.sbHfundlocatioDis')"
                          icon="search"
                          :readonly="true"
                          v-model="formEmpValidate.sbHfundlocatio"
                          @on-click="selectHfundlocatio($t('lang_employee.searchTableTitle.hfundlocatio'))"
                        />
                      </span>
                    </FormItem>
                  </Col>
                  <Col span="11" offset="1">
                    <FormItem
                      :label="$t('lang_employee.payInfo.sbHfundpolicy')"
                      prop="sbHfundpolicy"
                    >
                      <span @dblclick="dbsbHfundpolicy">
                        <Input
                          :placeholder="$t('lang_employee.payInfo.sbHfundpolicyDis')"
                          icon="search"
                          :readonly="true"
                          v-model="formEmpValidate.sbHfundpolicy"
                          @on-click="selectBenefitpolicy($t('lang_employee.searchTableTitle.hfundpolicy'), '2')"
                        />
                      </span>
                    </FormItem>
                  </Col>
                ...
                <a name="educationInfo">
                  <Icon type="compose" size="15" style="margin-right: 5px;"></Icon>
                  {{$t('lang_employee.educationInfo.title')}}
                </a>
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.educationInfo.edEducationlevel')"
                ...
                <Row>
                  <Col span="11">
                    <FormItem :label="$t('lang_employee.educationInfo.edSchool')" prop="edSchool">
                      <Input
                        :placeholder="$t('lang_employee.educationInfo.edSchoolDis')"
                ...
                <Row>
                  <Col span="11">
                    <FormItem :label="$t('lang_employee.educationInfo.edDegree')" prop="edDegree">
                      <Input
                        :placeholder="$t('lang_employee.educationInfo.edDegreeDis')"
                        v-model="formEmpValidate.edDegree"
                      />
                    </FormItem>
                  </Col>
                  <Col span="11" offset="1">
                    <FormItem
                      :label="$t('lang_employee.educationInfo.edSpecialty')"
                      prop="edSpecialty"
                    >
                      <Input
                        :placeholder="$t('lang_employee.educationInfo.edSpecialtyDis')"
                ...
                <a name="addressInfo">
                  <Icon type="compose" size="15" style="margin-right: 5px;"></Icon>
                  {{$t('lang_employee.addressInfo.title')}}
                </a>
                <Row>
                  <Col span="11">
                    <FormItem :label="$t('lang_employee.addressInfo.ctaMobile')" prop="ctaMobile">
                      <Input
                        :placeholder="$t('lang_employee.addressInfo.ctaMobileDis')"
                  ...
                  <Col span="11" offset="1">
                    <FormItem :label="$t('lang_employee.addressInfo.ctaPhone')" prop="ctaPhone">
                      <Input
                        :placeholder="$t('lang_employee.addressInfo.ctaPhoneDis')"
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.addressInfo.ctaPersmail')"
                      prop="ctaPersmail"
                    >
                      <Input
                        :placeholder="$t('lang_employee.addressInfo.ctaPersmailDis')"
                  ...
                  <Col span="11" offset="1">
                    <FormItem
                      :label="$t('lang_employee.addressInfo.ctaCompmail')"
                      prop="ctaCompmail"
                    >
                      <Input
                        :placeholder="$t('lang_employee.addressInfo.ctaCompmailDis')"
                ...
                <Row>
                  <Col span="11">
                    <FormItem :label="$t('lang_employee.addressInfo.ctaQq')" prop="ctaQq">
                      <Input
                        :placeholder="$t('lang_employee.addressInfo.ctaQqDis')"
                  ...
                  <Col span="11" offset="1">
                    <FormItem :label="$t('lang_employee.addressInfo.ctaWechat')" prop="ctaWechat">
                      <Input
                        :placeholder="$t('lang_employee.addressInfo.ctaWechatDis')"
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.addressInfo.ctaEmergcontact')"
                      prop="ctaEmergcontact"
                    >
                      <Input
                        :placeholder="$t('lang_employee.addressInfo.ctaEmergcontactDis')"
                  ...
                  <Col span="11" offset="1">
                    <FormItem
                      :label="$t('lang_employee.addressInfo.ctaEmcrelation')"
                      prop="ctaEmcrelation"
                    >
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.addressInfo.ctaEmcphone')"
                      prop="ctaEmcphone"
                    >
                      <Input
                        :placeholder="$t('lang_employee.addressInfo.ctaEmcphoneDis')"
                  ...
                  <Col span="11" offset="1">
                    <FormItem :label="$t('lang_employee.addressInfo.ctaEmcaddr')" prop="ctaEmcaddr">
                      <Input
                        :placeholder="$t('lang_employee.addressInfo.ctaEmcaddrDis')"
                ...
                <Row>
                  ...
                  <Col span="11" offset="1">
                    <FormItem
                      :label="$t('lang_employee.addressInfo.addProvince')"
                      prop="addProvince"
                    >
                      <span @dblclick="dbaddProvince">
                        <Input
                          :placeholder="$t('lang_employee.addressInfo.addProvinceDis')"
                          icon="search"
                          :readonly="true"
                ...
                <Row>
                  <Col span="11">
                    <FormItem :label="$t('lang_employee.addressInfo.addCity')" prop="addCity">
                      <span @dblclick="dbaddCity">
                        <Input
                          :placeholder="$t('lang_employee.addressInfo.addCityDis')"
                          icon="search"
                          :readonly="true"
                  ...
                  <Col span="11" offset="1">
                    <FormItem :label="$t('lang_employee.addressInfo.addStreet')" prop="addStreet">
                      <Input
                        :placeholder="$t('lang_employee.addressInfo.addStreetDis')"
                ...
                <Row>
                  <Col span="11">
                    <FormItem :label="$t('lang_employee.addressInfo.addZip')" prop="addZip">
                      <Input
                        :placeholder="$t('lang_employee.addressInfo.addZipDis')"
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.addressInfo.addrProvince')"
                      prop="addrProvince"
                    >
                      <span @dblclick="dbrProvince">
                        <Input
                          :placeholder="$t('lang_employee.addressInfo.addrProvinceDis')"
                          icon="search"
                          :readonly="true"
                  ...
                  <Col span="11" offset="1">
                    <FormItem :label="$t('lang_employee.addressInfo.addrCity')" prop="addrCity">
                      <span @dblclick="dbrCity">
                        <Input
                          :placeholder="$t('lang_employee.addressInfo.addrCityDis')"
                          icon="search"
                          :readonly="true"
                ...
                <Row>
                  <Col span="23">
                    <FormItem :label="$t('lang_employee.addressInfo.addrStreet')" prop="addrStreet">
                      <Input
                        :placeholder="$t('lang_employee.addressInfo.addrStreetDis')"
                ...
                <Row>
                  <Col span="11">
                    <FormItem
                      :label="$t('lang_employee.addressInfo.addrRegisterproperty')"
                  ...
                  <Col span="11" offset="1">
                    <FormItem :label="$t('lang_employee.addressInfo.addrZip')" prop="addrZip">
                      <Input
                        :placeholder="$t('lang_employee.addressInfo.addrZipDis')"
    ...
    <transition name="fade">
      <searchSbPolicy
        @inputBenefitpolicy="inputBenefitpolicy"
    ...
    return {
      ...
      ruleValidate: {
        baseGid: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.baseGid"),
            trigger: "blur"
          }
        ],
        baseCname: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.baseCname"),
            trigger: "blur"
          }
        ],
        baseLastname: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.baseLastname"),
            trigger: "blur"
          }
        ],
        baseFirstname: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.baseFirstname"),
            trigger: "blur"
          }
        ],
        idsType: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.idsType"),
            trigger: "blur, change"
          }
        ],
        idsNo: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.idsNo"),
            trigger: "blur"
          }
        ],
        baseBirthdate: [
          {
            required: true,
            type: "date",
            message: this.$t("lang_employee.empmasterCheck.baseBirthdate"),
            trigger: "blur, change"
          }
        ],
        baseGender: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.baseGender"),
            trigger: "blur, change"
          }
        ],
        baseMarriage: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.baseMarriage"),
            trigger: "blur, change"
          }
        ],
        baseNation: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.baseNation"),
            trigger: "blur, change"
          }
        ],
        basePolitical: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.basePolitical"),
            trigger: "blur, change"
          }
        ],
        baseTechnicaltitle: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.baseTechnicaltitle"),
            trigger: "blur, change"
          }
        ],
        baseTechspec: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.baseTechspec"),
            trigger: "blur"
          }
        ],
        baseFirstworkdate: [
          {
            required: true,
            type: "date",
            message: this.$t("lang_employee.empmasterCheck.baseFirstworkdate"),
            trigger: "blur, change"
          }
        ],
        baseTechdate: [
          {
            required: true,
            type: "date",
            message: this.$t("lang_employee.empmasterCheck.baseTechdate"),
            trigger: "blur, change"
          }
        ],
        pkiWorkno: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.pkiWorkno"),
            trigger: "blur"
          }
        ],
        pkiEmptype: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.pkiEmptype"),
            trigger: "blur, change"
          }
        ],
        compHirecompany: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.compHirecompany"),
            trigger: "blur, change"
          }
        ],
        compDept: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.compDept"),
            trigger: "blur, change"
          }
        ],
        compPost: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.compPost"),
            trigger: "blur, change"
          }
        ],
        compCostcenter: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.compCostcenter"),
            trigger: "blur, change"
          }
        ],
        compHirelocation: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.compHirelocation"),
            trigger: "blur, change"
          }
        ],
        compWorklocation: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.compWorklocation"),
            trigger: "blur, change"
          }
        ],
        compBuspmp: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.compBuspmp"),
            trigger: "blur, change"
          }
        ],
        compFunpmp: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.compFunpmp"),
            trigger: "blur, change"
          }
        ],
        compEntrydate: [
          {
            required: true,
            type: "date",
            message: this.$t("lang_employee.empmasterCheck.compEntrydate"),
            trigger: "blur, change"
          }
        ],
        compServicedate: [
          {
            required: true,
            type: "date",
            message: this.$t("lang_employee.empmasterCheck.compServicedate"),
            trigger: "blur, change"
          }
        ],
        compCertificatedate: [
          {
            ...
            type: "date",
            message: this.$t(
              "lang_employee.empmasterCheck.compCertificatedate"
            ),
            trigger: "blur, change"
          }
        ],
        compHr: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.compHr"),
            trigger: "blur, change"
          }
        ],
        ctContracttype: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.ctContracttype"),
            trigger: "blur, change"
          }
        ],
        ctContractperiod: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.ctContractperiod"),
            trigger: "blur, change"
          }
        ],
        ctContractsdate: [
          {
            required: true,
            type: "date",
            message: this.$t("lang_employee.empmasterCheck.ctContractsdate"),
            trigger: "blur, change"
          }
        ],
        ctContractedate: [
          {
            required: true,
            type: "date",
            message: this.$t("lang_employee.empmasterCheck.ctContractedate"),
            trigger: "blur, change"
          }
        ],
        ctContractprom: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.ctContractprom"),
            trigger: "blur, change"
          }
        ],
        ctConfidential: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.ctConfidential"),
            trigger: "blur, change"
          }
        ],
        ctContractworktime: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.ctContractworktime"),
            trigger: "blur, change"
          }
        ],
        ctSigndate: [
          {
            required: true,
            type: "date",
            message: this.$t("lang_employee.empmasterCheck.ctSigndate"),
            trigger: "blur, change"
          }
        ],
        ctProbation: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.ctProbation"),
            trigger: "blur, change"
          }
        ],
        ctProbationdate: [
          {
            required: true,
            type: "date",
            message: this.$t("lang_employee.empmasterCheck.ctProbationdate"),
            trigger: "blur, change"
          }
        ],
        ctProbationprom: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.ctProbationprom"),
            trigger: "blur, change"
          }
        ],
        salPostlevel: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.salPostlevel"),
            trigger: "blur, change"
          }
        ],
        salSalarylevel: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.salSalarylevel"),
            trigger: "blur, change"
          }
        ],
        salTravellevel: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.salTravellevel"),
            trigger: "blur, change"
          }
        ],
        salAdminlevel: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.salAdminlevel"),
            trigger: "blur, change"
          }
        ],
        salSalaryset: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.salSalaryset"),
            trigger: "blur, change"
          }
        ],
        bkBank: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.bkBank"),
            trigger: "blur, change"
          }
        ],
        bkAccount: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.bkAccount"),
            trigger: "blur"
          }
        ],
        bkAccnane: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.bkAccnane"),
            trigger: "blur"
          }
        ],
        sbBenefitlocation: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.sbBenefitlocation"),
            trigger: "blur, change"
          }
        ],
        sbHfundlocatio: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.sbHfundlocatio"),
            trigger: "blur, change"
          }
        ],
        sbBenefitpolicy: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.sbBenefitpolicy"),
            trigger: "blur, change"
          }
        ],
        sbBenefittype: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.sbBenefittype"),
            trigger: "blur, change"
          }
        ],
        sbHfundpolicy: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.sbHfundpolicy"),
            trigger: "blur, change"
          }
        ],
        sbHfundtype: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.sbHfundtype"),
            trigger: "blur, change"
          }
        ],
        edEducationlevel: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.edEducationlevel"),
            trigger: "blur, change"
          }
        ],
        edCuntry: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.edCuntry"),
            trigger: "blur, change"
          }
        ],
        edSchool: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.edSchool"),
            trigger: "blur"
          }
        ],
        edDegree: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.edDegree"),
            trigger: "blur"
          }
        ],
        edSpecialty: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.edSpecialty"),
            trigger: "blur"
          }
        ],
        edSdate: [
          {
            required: true,
            type: "date",
            message: this.$t("lang_employee.empmasterCheck.edSdate"),
            trigger: "blur, change"
          }
        ],
        edEdate: [
          {
            required: true,
            type: "date",
            message: this.$t("lang_employee.empmasterCheck.edEdate"),
            trigger: "blur, change"
          }
        ],
        ctaMobile: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.ctaMobile"),
            trigger: "blur"
          }
        ],
        ctaPhone: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.ctaPhone"),
            trigger: "blur"
          }
        ],
        ctaPersmail: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.ctaPersmail"),
            trigger: "blur"
          }
        ],
        ctaCompmail: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.ctaCompmail"),
            trigger: "blur"
          }
        ],
        ctaQq: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.ctaQq"),
            trigger: "blur"
          }
        ],
        ctaWechat: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.ctaWechat"),
            trigger: "blur"
          }
        ],
        ctaEmergcontact: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.ctaEmergcontact"),
            trigger: "blur"
          }
        ],
        ctaEmcrelation: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.ctaEmcrelation"),
            trigger: "blur, change"
          }
        ],
        ctaEmcphone: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.ctaEmcphone"),
            trigger: "blur"
          }
        ],
        ctaEmcaddr: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.ctaEmcaddr"),
            trigger: "blur"
          }
        ],
        addCuntry: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.addCuntry"),
            trigger: "blur, change"
          }
        ],
        addProvince: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.addProvince"),
            trigger: "blur, change"
          }
        ],
        addCity: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.addCity"),
            trigger: "blur, change"
          }
        ],
        addStreet: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.addStreet"),
            trigger: "blur"
          }
        ],
        addZip: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.addZip"),
            trigger: "blur"
          }
        ],
        addrCuntry: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.addrCuntry"),
            trigger: "blur, change"
          }
        ],
        addrProvince: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.addrProvince"),
            trigger: "blur, change"
          }
        ],
        addrCity: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.addrCity"),
            trigger: "blur, change"
          }
        ],
        addrStreet: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.addrStreet"),
            trigger: "blur"
          }
        ],
        addrRegisterproperty: [
          {
            required: true,
            message: this.$t(
              "lang_employee.empmasterCheck.addrRegisterproperty"
            ),
            trigger: "blur, change"
          }
        ],
        addrZip: [
          {
            required: true,
            message: this.$t("lang_employee.empmasterCheck.addrZip"),
            trigger: "blur"
          }
        ]
      }
  ...
  methods: {
    handleSubmit() {
      ...
      let empBase = {
        ...
        empBirthdate:
          dataValue.baseBirthdate === ""
            ? ""
            : new Date(dataValue.baseBirthdate).format("yyyy-MM-dd"),
        empNation: dataValue.nationPCode,
        empMarriage: dataValue.baseMarriage,
        empPolitical: dataValue.basePolitical,
        empFirstworkdate:
          dataValue.baseFirstworkdate === ""
            ? ""
            : new Date(dataValue.baseFirstworkdate).format("yyyy-MM-dd"),
        empTechnicaltitle: dataValue.baseTechnicaltitle,
        empTechspec: dataValue.baseTechspec,
        empTechdate:
          dataValue.baseTechdate === ""
            ? ""
            : new Date(dataValue.baseTechdate).format("yyyy-MM-dd")
      };
      //      证件信息
      let empIds = {
      ...
      let empCompany = {
        ...
        empcompEntrydate:
          dataValue.compEntrydate === ""
            ? ""
            : new Date(dataValue.compEntrydate).format("yyyy-MM-dd"),
        empcompServicedate:
          dataValue.compServicedate === ""
            ? ""
            : new Date(dataValue.compServicedate).format("yyyy-MM-dd"),
        empcompCertificatedate:
          dataValue.compCertificatedate === ""
            ? ""
            : new Date(dataValue.compCertificatedate).format("yyyy-MM-dd"),
      ...
      let empContract = {
        ...
        empctContractsdate:
          dataValue.ctContractsdate === ""
            ? ""
            : new Date(dataValue.ctContractsdate).format("yyyy-MM-dd"),
        empctContractedate:
          dataValue.ctContractedate === ""
            ? ""
            : new Date(dataValue.ctContractedate).format("yyyy-MM-dd"),
        ...
        empctSigndate:
          dataValue.ctSigndate === ""
            ? ""
            : new Date(dataValue.ctSigndate).format("yyyy-MM-dd"),
        empctProbation: dataValue.ctProbation,
        empctProbationdate:
          dataValue.ctProbationdate === ""
            ? ""
            : new Date(dataValue.ctProbationdate).format("yyyy-MM-dd"),
      ...
      let empEducation = {
        ...
        empedSdate:
          dataValue.edSdate === ""
            ? ""
            : new Date(dataValue.edSdate).format("yyyy-MM-dd"),
        empedEdate:
          dataValue.edEdate === ""
            ? ""
            : new Date(dataValue.edEdate).format("yyyy-MM-dd")
      };
      //      联系地址信息
      let empContact = {
    ...
    getSelect() {
      ...
      getDataLevelUserLogin({
        ...
        typeCode:
          "gender,marrystatus,political,techlevel,emptype,contrpertype,postlevel,salarylevel,travellevel,adminlevel,education,relationship,benefitacctype,idtype,registerproperty,worktimetype,contperiod,noticedays,confidential,probperiod"
      })
        .then(res => {
          if (isSuccess(res, t)) {
            ...
            t.selectctContractworktime =
              res.data.content[0].value[15].paramList;
    ...
    selectPost() {
      ...
      if (t.formEmpValidate.compDeptPid === "") {
        ...
        t.$refs.searchPost.getData(
          paramsPost,
          "unit" + t.formEmpValidate.compDeptPid
        );
        t.openPost = true;
      }
    },
    ...
    selectBenefitlocation(logType) {
      const t = this;
      t.logType = logType;
      t.$refs.searchHirelocation.getData(
        this.paramsHirelocation,
        "02city','03county"
      );
      t.openHirelocation = true;
    },
