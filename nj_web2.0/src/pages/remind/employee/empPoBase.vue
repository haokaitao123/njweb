      ...
      <row>
        <i-col class="meau-left" span="5">
          ...
          <Menu :active-name="active" width="auto" @on-select="pageTo">
            ...
            <MenuItem :name="$store.state.user.funId">员工基础信息</MenuItem>
            <MenuItem :name="1036">学历信息管理</MenuItem>
            <MenuItem :name="1037">合同信息管理</MenuItem>
            <MenuItem :name="1038">工作经历管理</MenuItem>
            <MenuItem :name="1039">家庭成员管理</MenuItem>
