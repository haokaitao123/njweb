    ...
    <Row>
      ...
      <card>
        <p slot="title">
          ...
          &nbsp;{{$t('lang_financialMan.orderPriceSetting.tilte')}}
        </p>
        <Row>
        	...
        	<i-col span="20" style="width: 83.3333% !important">
        		<Row>
		          <Input :placeholder="$t('lang_financialMan.orderPriceSetting.searhText')" style="width: 200px" v-model="cmutKntypeCode"/>
    ...
    data() {
      return {
        ...
        columns: [
          ...
          {
            title: this.$t('lang_financialMan.orderPriceSetting.cmutKntypePid'),
            key: 'cmutKntypePidDis',
          },
          {
            title: this.$t('lang_financialMan.orderPriceSetting.cmutKntypeDesc'),
            key: 'cmutKntypeDesc',
//            sortable: 'custom',
//            width: 150,
          },
        ...
        getDataLevelUserLogin(data).then((res) => {
          if (isSuccess(res, t)) {
          	if (res.data.content[0].value) {
	              ...
	              id: '0',
	              cmutKntypeName: this.$t('lang_financialMan.orderPriceSetting.allType'),
	            })
