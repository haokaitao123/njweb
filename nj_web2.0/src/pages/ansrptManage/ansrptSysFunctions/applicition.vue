                ...
                <Row :style="{height: rowHeight + 'px'}"
                    ...
                    <div style="height: 85%;overflow:auto;">
                        ...
                        <div v-for="(item, index) in toDoAllData"
                             :key="index"
                             class="dataClass">
                            <el-checkbox-group class="checkGroup"
                                               v-model="checkedCities"
                                               @change="handleCheckedCitiesChange">
                                <el-checkbox class="checks"
                                             :label="item"
                    ...
                    <div class="topBtn">
                        <div class="chooseAll">
                            <el-checkbox :indeterminate="isIndeterminate"
                                         v-model="checkAll"
                                         @change="handleCheckAllChange"></el-checkbox>&nbsp;&nbsp; 全选
                        </div>
                        <div class="btns">
                            <div class="leftBtn">
                                <el-button size="mini"
                                           @click.native="isSubmit('02noneapproved','不同意')">不同意</el-button>
                                <el-button type="primary"
                                           size="mini"
                                           @click.native="isSubmit('01approved','同意')">同意</el-button>
                            </div>
                            <div class="rightBtn">
                            </div>
                        </div>
