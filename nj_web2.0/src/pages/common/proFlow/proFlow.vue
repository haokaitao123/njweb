      ...
      <Row>
        <i-col span="24">
			            <!--<span @dblclick="clearKnowType">-->
			              <!--问题类型：<Input v-model="this.$store.state.myWorkOrderNew.ProblemTypeName" icon="search" :readonly="true" placeholder="请选择业务工单类型" style="width: 160px;margin-right: 10px;" @on-click="pickData" />-->
			            <!--</span>-->
          ...
          {{$t('lang_communication.myWorkOrderNew.cmwdkeyWord')}}：<Input :placeholder="$t('lang_communication.myWorkOrderNew.cmwdkeyWord')"   v-model="cmwdkeyWord" style="width: 80px;"  />
          {{$t('lang_communication.proFlow.flowWorkno')}}：<Input :placeholder="$t('lang_communication.proFlow.flowWorknoDis')"   v-model="flowWorkno" style="width: 80px;"  />
          <span @dblclick="dbHCompany">
                {{$t('lang_communication.proFlow.pladCompany')}}：<Input v-model="pladCompanyDis" :placeholder="$t('lang_communication.proFlow.pladCompanyDis')" style="width: 80px" icon="search" :readonly="true"   @on-click="selectHCompany"/>
          </span>
          <span @dblclick="clearDepart">
               {{$t('lang_communication.proFlow.pladDept')}}：<Input v-model="pladDeptDis" style="width: 80px" icon="search" :readonly="true"  :placeholder="$t('lang_communication.proFlow.pladDeptDis')"  @on-click="pickDepart"/>
          </span>
          {{$t('lang_communication.proFlow.flowCName')}}：<Input :placeholder="$t('lang_communication.proFlow.flowCNameDis')"   v-model="flowCName" style="width: 80px;"  />
