    ...
    <div class="box">
      ...
      <div class="content-main">
        ...
        <Row style="display: flex">
          <Page :total="total" size="small" show-elevator show-sizer placement="top" :current="page" @on-page-size-change="sizeChange" @on-change="pageChange":page-size-opts = "[10, 20, 50, 100]" ></Page><Button type="ghost" size="small" shape="circle" icon="refresh" style="margin-left: 20px;display: inline-block;" @click="getData(1)"></Button></Row>
      </div>
    </div>
  </div>
</template>
    ...
    data() {
      return {
        ...
        columns: [
          ...
          {
            title: this.$t('lang_communication.commonFlowUpdate2.payproPeriod'),
            key: 'payerrPeriod',
          },
          {
...

         {
          ...
          {
            title: this.$t('lang_payroll.commonFlowUpdate2.payerrErrortype'),
            key: 'payerrErrortypeDis',
          },
          {
            title: this.$t('lang_payroll.commonFlowUpdate2.payerrErrorinfo'),
            key: 'payerrErrorinfo',
          },
           {
            title: this.$t('lang_payroll.commonFlowUpdate2.payerrResperson'),
            key: 'payerrRespersonDis',
          },
          {
            title: this.$t('lang_payroll.commonFlowUpdate2.payerrDealstatus'),
            key: 'payerrDealstatusDis',
          },
           {
            title: this.$t('lang_payroll.commonFlowUpdate2.payerrDealperson'),
            key: 'payerrDealpersonDis',
          },
          {
            title: this.$t('lang_payroll.commonFlowUpdate2.payerrDealtime'),
            key: 'payerrDealtime',
          },
