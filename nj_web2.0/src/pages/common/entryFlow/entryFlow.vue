    ...
    <Row>
      ...
      <Row>
        <i-col span="24">
          ...
          {{$t('lang_communication.entryFlow.flowWorkno')}}：<Input :placeholder="$t('lang_communication.entryFlow.flowWorknoDis')"   v-model="flowWorkno" style="width: 80px;"  />
          <span @dblclick="dbHCompany">
               {{$t('lang_communication.entryFlow.pladCompany')}}<Input v-model="pladCompanyDis" :placeholder="$t('lang_communication.entryFlow.pladCompanyDis')" style="width: 80px" icon="search" :readonly="true"   @on-click="selectHCompany"/>
          </span>
          <span @dblclick="clearDepart">
              {{$t('lang_communication.entryFlow.pladDept')}}<Input v-model="pladDeptDis" style="width: 80px" icon="search" :readonly="true"  :placeholder="$t('lang_communication.entryFlow.pladDeptDis')"  @on-click="pickDepart"/>
          </span>
          {{$t('lang_communication.entryFlow.flowCName')}}：<Input :placeholder="$t('lang_communication.entryFlow.flowCNameDis')"   v-model="flowCName" style="width: 80px;"  />
