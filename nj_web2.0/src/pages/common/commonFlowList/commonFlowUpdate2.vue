  ...
  <div>
        ...
        <Form ref="ruleForm" :model="ruleForm" :rules="ruleValidate" :label-width="200">
          <div class="title">
            <div class="title-text">
              <Icon type="mouse" size="16" style="margin-right: 10px;"></Icon>{{thisSetpName===''?'':thisSetpName}}
            </div>
                      ...
                      <Spin size="large" v-if="!item.blockColumn" fix></Spin>
                          ...
                          <Row>
                              <Col span="22" offset="1">
                                <p style="text-align:center">薪资计划已发布，查看请点击 <a href="javascript:void(0);" @click="openUpDate(payproSalset.payproPlanId,'查看',0)" style="width:100px;display:inline-block;"  >薪资计划</a></p>
                              </Col>
                          </Row>
                    </div>
                </div>
    ...
    <Modal v-model="isModel" width="360">
        ...
        <div style="text-align:left">
           <Row>
          <Col span="6" offset="1">联系人：</Col>
          <Col span="17" >{{userInfo.payssContact}}</Col>
        </Row>
        <Row>
          <Col span="6" offset="1" >联系电话：</Col>
        ...
        <div slot="footer">
            <Button type="success" size="large"   @click="closeModelSure">关闭</Button>
        </div>
    </Modal>
...
import PayproSalset from "./flowPayproSalsetList.vue";
import salaryComputation from "./flowPaySalaryComputation.vue";
import flowPayErrorList from "./flowPayErrorList.vue";
import flowPaySureErrorList from "./flowPaySureErrorList.vue";
import {
  getDataLevelUserLogin,
  getDataLevelUserLoginNew2,
  getDataLevelUserLoginNew3,
  uploadFile
} from "../../../axios/axios";
import {
  isSuccess,
      ...
      getDataLevelUserLogin({
        ...
        .then(res => {
          if (isSuccess(res, t)) {
            ...
            console.log(t.operation, "5555555555555555555");
