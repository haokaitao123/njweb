    ...
    <Row>
      ...
      <Row>
        <i-col span="24">
          ...
          {{$t('lang_communication.dimFlow.flowWorkno')}}：<Input :placeholder="$t('lang_communication.dimFlow.flowWorknoDis')"   v-model="flowWorkno" style="width: 80px;"  />
          <span @dblclick="dbHCompany">
               {{$t('lang_communication.dimFlow.pladCompany')}}<Input v-model="pladCompanyDis" :placeholder="$t('lang_communication.dimFlow.pladCompanyDis')" style="width: 80px" icon="search" :readonly="true"   @on-click="selectHCompany"/>
          </span>
          <span @dblclick="clearDepart">
              {{$t('lang_communication.dimFlow.pladDept')}}<Input v-model="pladDeptDis" style="width: 80px" icon="search" :readonly="true"  :placeholder="$t('lang_communication.dimFlow.pladDeptDis')"  @on-click="pickDepart"/>
          </span>
          {{$t('lang_communication.dimFlow.flowCName')}}：<Input :placeholder="$t('lang_communication.dimFlow.flowCNameDis')"   v-model="flowCName" style="width: 80px;"  />
