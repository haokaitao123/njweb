<template>
  <div class="content-main">
    ...
    <contentMsg v-show="showMsg" :logType="logType" :sibaEntrydate="sibaEntrydate" :selectPcyinsIns="selectPcyinsIns" @hideMsg="hideMsg" :id="id" :idname="idname" ref="contentMsg" @getData="getdata" @update="updateArray" ></contentMsg>
  </div>
</template>
<script>
