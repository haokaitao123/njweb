    ...
    <Row>
      <Col span="24">
        ...
        <p slot="title">
          ...
          &nbsp;&nbsp;{{$t('lang_sihfPolicy.sihfBenefitadd.title2')}}
        </p>
        <Row>
    ...
    data() {
      return {
        ...
        columns: [
          ...
          {
            title: this.$t('lang_sihfPolicy.sihfBenefitadd.sibaIsconfirm'),
            key: 'sibaIsconfirmDis',
            width: 100,
            fixed: 'right',
            align: 'center',
          },
    ...
    methods: {
      ...
      handSubmit() {
        ...
        if (t.tableselected.length === 0) {
          ...
          const data = {
            _mt: 'sihfBenefitadd.checkIsConfirm',
            funId: '1',
            logType: this.$t('lang_sihfPolicy.sihfBenefitadd.isTrue'),
