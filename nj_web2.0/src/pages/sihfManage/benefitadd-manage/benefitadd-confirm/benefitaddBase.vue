      ...
      <row>
        ...
        <i-col class="meau-right" span="19">
          ...
          <div style="margin-top: 40px;padding: 10px;">
            <mOption v-show="option" :logType="logType" ref="option" @getEntryDate="getEntryDate" :id="id" @update="update" @newdata="newdata"></mOption>
  ...
  export default {
    ...
    methods: {
      ...
      pageTo(name) {
        ...
        this[name] = true
        if (name === 'content') {
          this.$refs.content.get(this.id, this.sibaEntrydate)
        } else {
