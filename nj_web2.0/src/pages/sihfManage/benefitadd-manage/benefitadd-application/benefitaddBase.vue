      ...
      <row>
        ...
        <i-col class="meau-right" span="19">
          ...
          <div style="margin-top: 40px;padding: 10px;">
            <mOption v-show="option" :logType="logType" ref="option" @getParams="getParams" :id="id" @update="update" @newdata="newdata"></mOption>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getParams(date, policy) {
        this.sibaEntrydate = date
        this.sibaBenefitpolicy = policy
      },
      pageTo(name) {
        this.option = false
        this.content = false
        ...
        this[name] = true
        if (name === 'content') {
          this.$refs.content.get(this.id, this.sibaEntrydate, this.sibaBenefitpolicy)
        } else {
