    ...
    <div class="box">
      ...
      <Row>
        <Form :model="form" label-position="right"  ref="form" :label-width="120">
          ...
          <i-col span="11" v-show="sibaStatus === '30success'? true:false">
            <FormItem :label="$t('lang_sihfPolicy.benefitaddInsurance.sibainsSuccmonth')" prop="sibainsSuccmonth">
              <Input v-model="form.sibainsSuccmonth" disabled :placeholder="$t('lang_sihfPolicy.benefitaddInsurance.sibainsSuccmonth')"></Input>
            </FormItem>
          </i-col>
          <i-col span="23">
