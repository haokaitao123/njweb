...
<script>
  import contentMsg from './sihfPlcyinsuranceView'
  ...
  export default {
    data() {
      return {
        ...
        columns: [
          ...
          {
            title: this.$t('lang_sihfPolicy.sihtPlcyinsurance.sihfpcyinsPolicyName'),
        ...
        params: {
          ...
          order: 'asc',
          sihfpcyinsIns: '',
          sihfpcyinsPolicyid: this.$store.state.sihfPo.childId1,
    ...
    methods: {
      getdata() {
        ...
        t.params.sihfpcyinsPolicyid = t.$store.state.sihfPo.childId1
      ...
      showMsgBtn(id, logType, index) {
        ...
        t.index = index
        t.logType = logType
        t.sihfpcy = t.$store.state.sihfPo.sihfpcy
