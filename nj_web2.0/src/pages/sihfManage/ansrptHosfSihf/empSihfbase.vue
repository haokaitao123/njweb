        ...
        <i-col class="meau-left" span="5">
          <Menu :active-name="active" width="auto" @on-select="pageTo">
            ...
            <MenuItem name="content" >
              {{$t('lang_ansrptEmpSihf.ansrptEmpSihf.basechiHosftitle')}}
            </MenuItem>
          </Menu>
        </i-col>
...
<script>
  import mOption from './editEmpSihf'
  import mContent from './empSihfChild'
  ...
  export default {
    ...
    methods: {
      ...
      getOption(logType) {
        this.data.id = this.$store.state.ansrptEmpSihf.mainId
