<template>
  <div class="content-main">
    ...
    <contentMsg v-show="showMsg" @hideMsg="hideMsg" :id="id" :idname="idname" ref="contentMsg" @getData="addNewArray"
  ...
  export default {
    ...
    methods: {
      getdata() {
        ...
        t.params.empinsEmpid = t.$store.state.ansrptHosfSihf.childId1
