    ...
    <div class="box">
      ...
      <Form ref="form" :model="form" :rules="ruleValidate" :label-width="100">
        <Row>
          ...
          <FormItem :label="$t('lang_sihfPolicy.sihfBenefitadd.sibaSberror')" prop="sihfeSberror">
            <Input v-model="form.sihfeSberror" type="textarea" :autosize="{minRows: 2,maxRows: 2}" :placeholder="$t('lang_sihfPolicy.sihfBenefitadd.sibaSberrorDis')"></Input>
          </FormItem>
          </Col>
        </Row>
        <Row>
...
<script>
  ...
  export default {
    ...
    methods: {
      handleSubmit() {
        const t = this
        t.data._mt = 'sihfHfundend.confirm'
        t.data.sihfeStatus = '40fail'
        t.data.sihfeSberror = this.form.sihfeSberror
