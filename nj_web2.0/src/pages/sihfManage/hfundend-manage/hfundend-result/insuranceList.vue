<template>
  <div class="content-main">
    ...
    <contentMsg v-show="showMsg" :logType="logType"  :sihfeLastemployday="sihfeLastemployday" :sihfeStatus="sihfeStatus" :selectPcyinsIns="selectPcyinsIns" @hideMsg="hideMsg" :id="id" :idname="idname" ref="contentMsg" @getData="getdata" @update="updateArray" ></contentMsg>
  </div>
</template>
<script>
  ...
  export default {
    ...
    methods: {
      get(id, sihfeLastemployday, sibaStatus) {
        this.sihfeLastemployday = sihfeLastemployday
        this.sihfeStatus = sibaStatus
