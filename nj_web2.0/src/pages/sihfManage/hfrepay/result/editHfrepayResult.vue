      ...
      <Form :model="form" label-position="right" :rules="ruleValidate" ref="form" :label-width="140">
        <i-col span="11">
          <FormItem :label="$t('lang_hfrepay.sihfHfrepay.sihfrpCompany')">
            <Input  icon="search" disabled :placeholder="$t('lang_hfrepay.sihfHfrepay.sihfrpCompanyPrompt')" v-model="form.sihfrpCompanyDis"/>
          </FormItem>
        </i-col>
        <i-col span="11" offset="1">
          <FormItem :label="$t('lang_hfrepay.sihfHfrepay.sihfrpDept')">
            <Input icon="search" disabled :placeholder="$t('lang_hfrepay.sihfHfrepay.sihfrpDeptPrompt')" v-model="form.sihfrpDeptDis"/>
          </FormItem>
        </i-col>
        <i-col span="11">
        ...
        <i-col span="11" >
          <FormItem :label="$t('lang_hfrepay.sihfHfrepay.sihfrpBenefittype')"  prop="sihfrpBenefittype">
            <Select v-model="form.sihfrpBenefittype" disabled
                    :placeholder="$t('lang_hfrepay.sihfHfrepay.sihfrpBenefittype')">
        ...
        <i-col span="11" >
          <FormItem :label="$t('lang_hfrepay.sihfHfrepay.sihfrpConfirmer')" >
            <Input v-model="form.sihfrpConfirmerDis" disabled></Input>
          </FormItem>
        </i-col>
        <i-col span="11" offset="1">
          <FormItem :label="$t('lang_hfrepay.sihfHfrepay.sihfrpConfirmtime')">
            <Input v-model="form.sihfrpConfirmtime" disabled></Input>
          </FormItem>
        </i-col>
        <i-col span="23">
          <FormItem :label="$t('lang_hfrepay.sihfHfrepay.sihfrpConfirmrecord')">
            <Input v-model="form.sihfrpConfirmrecord" :autosize="{minRows: 2,maxRows: 5}" disabled type="textarea"></Input>
          </FormItem>
        </i-col>
        <i-col span="11" v-show="form.sihfrpStatus === '40fail' || form.sihfrpStatus === '30success'? true:false">
          <FormItem :label="$t('lang_hfrepay.sihfHfrepay.sihfrpSbperson')" >
            <Input v-model="form.sihfrpSbpersonDis" disabled></Input>
          </FormItem>
        </i-col>
        <i-col span="11" offset="1" v-show="form.sihfrpStatus === '40fail' || form.sihfrpStatus === '30success'? true:false">
          <FormItem :label="$t('lang_hfrepay.sihfHfrepay.sihfrpSbtime')">
            <Input v-model="form.sihfrpSbtime" disabled></Input>
          </FormItem>
        </i-col>
        <i-col span="23">
    ...
    methods: {
      getdata() {
        ...
        const params = {
          ...
          id: t.$store.state.hfrepayResult.mainId,
          logType: '根据id查询',
        }
        getDataLevelUserLogin(params).then((res) => {
          if (isSuccess(res, t)) {
            ...
            this.form.sihfrpConfirmer = res.data.content[0].sihfrpConfirmer
            this.form.sihfrpConfirmerDis = res.data.content[0].sihfrpConfirmerDis
            this.form.sihfrpConfirmtime = res.data.content[0].sihfrpConfirmtime
            ...
            this.form.sihfrpSbpersonDis = res.data.content[0].sihfrpSbpersonDis
            this.form.sihfrpSbperson = res.data.content[0].sihfrpSbperson
            this.form.sihfrpSbtime = res.data.content[0].sihfrpSbtime
            this.form.sihfrpConfirmrecord = res.data.content[0].sihfrpConfirmrecord
          }
        }).catch(() => {
          t.$Modal.error({
      ...
      save() {
        ...
        if (t.$store.state.hfrepayResult.mainId) {
          data.id = t.$store.state.hfrepayResult.mainId
        }
        ...
        this.$refs.form.validate((valid) => {
          if (valid) {
            getDataLevelUserLoginNew(data).then((res) => {
              if (isSuccess(res, t)) {
                t.$store.commit('hfrepayResult/setMainId', res.data.content[0].id)
//                t.$emit('closeUp')
      ...
      clear() {
        ...
        this.form.sihfrpConfirmer = ''
        this.form.sihfrpConfirmerDis = ''
        this.form.sihfrpConfirmtime = ''
        this.form.sihfrpIsconfirm = ''
        this.form.sihfrpNocmreason = ''
        this.form.sihfrpSbtime = ''
        this.form.sihfrpSbpersonDis = ''
        this.form.sihfrpSbperson = ''
        this.$store.commit('hfrepayResult/setMainId', '')
