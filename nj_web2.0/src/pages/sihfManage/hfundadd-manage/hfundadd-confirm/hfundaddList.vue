    ...
    <Row>
      <Col span="24">
        ...
        <p slot="title">
          ...
          &nbsp;{{$t('lang_sihfPolicy.hfundadd.title2')}}
        </p>
        <Row>
    ...
    data() {
      return {
        ...
        columns: [
          ...
          {
            title: this.$t('lang_sihfPolicy.hfundadd.sihfaIsconfirm'),
            key: 'sihfaIsconfirmDis',
            width: 100,
            fixed: 'right',
            align: 'center',
          },
    ...
    methods: {
      ...
      handSubmit() {
        ...
        if (t.tableselected.length === 0) {
          ...
          const data = {
            _mt: 'sihfHfundadd.checkIsConfirm',
            funId: '1',
