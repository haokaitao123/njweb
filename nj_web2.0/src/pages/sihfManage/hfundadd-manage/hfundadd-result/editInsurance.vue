    ...
    <div class="box">
      ...
      <Row>
        <Form :model="form" label-position="right"  ref="form" :label-width="120">
          ...
          <i-col span="11" v-show="sihfaStatus === '30success'? true:false">
            <FormItem :label="$t('lang_sihfPolicy.hfundaddInsurance.sihfainsSuccmonth')" prop="sihfainsSuccmonth">
              <Input v-model="form.sihfainsSuccmonth" disabled :placeholder="$t('lang_sihfPolicy.hfundaddInsurance.sihfainsSuccmonthDis')"></Input>
            </FormItem>
          </i-col>
          <i-col span="23">
            <FormItem :label="$t('lang_sihfPolicy.hfundaddInsurance.sihfainsComment')" prop="sihfainsComment">
              <Input v-model="form.sihfainsComment" disabled type="textarea" :autosize="{minRows: 2,maxRows: 5}" :placeholder="$t('lang_sihfPolicy.hfundaddInsurance.sihfainsCommentDis')"></Input>
            </FormItem>
          </i-col>
        </Form>
      </Row>
