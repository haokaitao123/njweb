<template>
  <div class="content-main">
    ...
    <contentMsg v-show="showMsg" :logType="logType" :sihfaEntrydate="sihfaEntrydate" :sihfaStatus="sihfaStatus" :selectPcyinsIns="selectPcyinsIns" @hideMsg="hideMsg" :id="id" :idname="idname" ref="contentMsg" @getData="getdata" @update="updateArray" ></contentMsg>
  </div>
</template>
<script>
  ...
  export default {
    ...
    methods: {
      get(id, sihfaEntrydate, sihfaStatus) {
        this.sihfaEntrydate = sihfaEntrydate
        this.sihfaStatus = sihfaStatus
