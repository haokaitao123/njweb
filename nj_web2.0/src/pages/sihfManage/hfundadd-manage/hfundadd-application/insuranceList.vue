<template>
  <div class="content-main">
    ...
    <contentMsg v-show="showMsg" :logType="logType" :sihfaEntrydate="sihfaEntrydate" :sihfaHfundpolicy="sihfaHfundpolicy" :selectPcyinsIns="selectPcyinsIns" @hideMsg="hideMsg" :id="id" :idname="idname" ref="contentMsg" @getData="getdata" @update="updateArray" ></contentMsg>
  </div>
</template>
<script>
  ...
  export default {
    ...
    methods: {
      get(id, sihfaEntrydate, sihfaHfundpolicy) {
        this.sihfaEntrydate = sihfaEntrydate
        this.sihfaHfundpolicy = sihfaHfundpolicy
