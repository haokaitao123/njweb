    ...
    <div class="box">
      ...
      <Row class="content">
        <Form :model="form" ref="form" label-position="right" :rules="ruleValidate" :label-width="120">
          <i-col span="11" >
            <FormItem label="公积金政策" prop="sihfpcy">
              <Input v-model="sihfpcy" :disabled="true" placeholder="请输入公积金政策" ></Input>
            </FormItem>
          </i-col>
          <i-col span="11" >
          ...
          <i-col span="11" >
            <FormItem :label="$t('lang_sihfPolicy.sihtPlcyinsurance.sihfpcyinsCrtypeName')" prop="sihfpcyinsCrtype">
              <Select v-model="form.sihfpcyinsCrtype"   :placeholder="$t('lang_sihfPolicy.sihtPlcyinsurance.sihfpcyinsCrtypeNameDis')">
          ...
          <i-col span="11" >
            <FormItem :label="$t('lang_sihfPolicy.sihtPlcyinsurance.sihfpcyinsPrtypeName')" prop="sihfpcyinsPrtype">
              <Select v-model="form.sihfpcyinsPrtype"   :placeholder="$t('lang_sihfPolicy.sihtPlcyinsurance.sihfpcyinsPrtypeNameDis')">
                <Option :value="item.paramCode" v-for="(item,index) in selectInsratetype" :key="index">{{item.paramInfoCn}}</Option>
              </Select>
            </FormItem>
          </i-col>
  ...
  export default {
    data() {
      return {
        ...
        ruleValidate: {
          sihfpcyinsIns: [
            { required: true, message: this.$t('lang_sihfPolicy.sihtPlcyinsurance.sihfpcyinsInsNameDis'), trigger: 'blur' },
          ],
          sihfpcyinsOrder: [
    ...
    methods: {
      ...
      save() {
        ...
        params.logType = '新增'
        params.sihfpcyinsPolicyid = t.$store.state.providFund.childId1
