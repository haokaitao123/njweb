    ...
    methods: {
      getdata() {
        ...
        const params = {
          ...
          id: t.$store.state.providFund.mainId,
          logType: '根据id查询',
        }
        getDataLevelUserLogin(params).then((res) => {
          if (isSuccess(res, t)) {
            this.form.sihfpcyNo = res.data.content[0].sihfpcyNo
            this.$store.commit('providFund/setSihfpcy', res.data.content[0].sihfpcy) //传递给子表显示,新增时默认显示
      ...
      save() {
        ...
        if (t.$store.state.providFund.mainId) {
          data.id = t.$store.state.providFund.mainId
        }
        ...
        getDataLevelUserLoginNew(data).then((res) => {
          if (isSuccess(res, t)) {
            t.$emit('newdata')
            t.$store.commit('providFund/setSihfpcy', res.data.content[0].sihfpcy)
            t.$store.commit('providFund/setChildId1', res.data.content[0].id)
      ...
      clear() {
        ...
        this.form.sihfpcySamebase = ''
        this.form.sihfpcySdate = ''
        this.form.sihfpcyEdate = ''
        this.sihfpcyAreaName = ''
        this.form.sihfpcyComment = ''
        this.$store.commit('providFund/setSihfpcy', '')
        this.$store.commit('providFund/setChildId1', '')
        this.$store.commit('providFund/setMainId', '')
