...
<script>
  import mOption from './editRepayConfirm'
  import mContent from './repayConfirmChild'
  ...
  export default {
    ...
    methods: {
      ...
      getOption(logType) {
        ...
        this.data.id = this.$store.state.repayConfirm.mainId
