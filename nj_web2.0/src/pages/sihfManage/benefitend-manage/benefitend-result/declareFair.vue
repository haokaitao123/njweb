    ...
    <div class="box">
      ...
      <Form ref="form" :model="form" :rules="ruleValidate" :label-width="100">
        <Row>
          ...
          <FormItem :label="$t('lang_sihfPolicy.sihfBenefitadd.sibaSberror')" prop="sibeSberror">
            <Input v-model="form.sibeSberror" type="textarea" :autosize="{minRows: 2,maxRows: 2}" :placeholder="$t('lang_sihfPolicy.sihfBenefitadd.sibaSberrorDis')"></Input>
          </FormItem>
          </Col>
        </Row>
        <Row>
...
<script>
  ...
  export default {
    ...
    methods: {
      handleSubmit() {
        const t = this
        t.data._mt = 'sihfBenefitend.confirm'
        t.data.sibeStatus = '40fail'
        t.data.sibeSberror = this.form.sibeSberror
