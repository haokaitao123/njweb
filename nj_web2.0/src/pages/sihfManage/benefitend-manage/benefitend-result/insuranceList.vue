<template>
  <div class="content-main">
    ...
    <contentMsg v-show="showMsg" :logType="logType" :sibeLastemployday="sibeLastemployday" :sibeStatus="sibeStatus" :selectPcyinsIns="selectPcyinsIns" @hideMsg="hideMsg" :id="id" :idname="idname" ref="contentMsg" @getData="getdata" @update="updateArray" ></contentMsg>
  </div>
</template>
<script>
  ...
  export default {
    ...
    methods: {
      get(id, sibeLastemployday, sibaStatus) {
        this.sibeLastemployday = sibeLastemployday
        this.sibeStatus = sibaStatus
