    ...
    <Row>
      <Col span="24">
        ...
        <p slot="title">
          ...
          &nbsp;{{$t('lang_sihfPolicy.sihfBenefitend.title3')}}
        </p>
        <Row>
  ...
  export default {
            ...
            render: (h, params) => {
              return h('div', [
                ...
                h('Button', {
                  ...
                  style: {
                    marginRight: '5px',
                    display: this.sibeStatus === '\'20declare\'' ? 'inline' : 'none',
                  },
                  on: {
                    click: () => {
                      this.declareSucc(params.row.id, this.$t('lang_sihfPolicy.sihfBenefitend.declareSucc'), params.index)
                    },
                  },
                }, this.$t('lang_sihfPolicy.sihfBenefitend.declareSucc')),
                h('Button', {
                  props: {
                    type: 'error',
                    size: 'small',
                  ...
                  on: {
                    click: () => {
                      this.declareFair(params.row.id, this.$t('lang_sihfPolicy.sihfBenefitend.declareFair'), params.index)
                    },
                  },
                }, this.$t('lang_sihfPolicy.sihfBenefitend.declareFair')),
              ])
            },
          },
        ],
    ...
    methods: {
      ...
      declareSucc(id, logType, index) {
        ...
        getDataLevelUserLogin(t.params).then((res) => {
          if (isSuccess(res, t)) {
            ...
            if (t.form.sibeStatus === '30success' || t.form.sibeStatus === '40fail') {
              t.$Modal.error({
                title: this.$t('reminder.err'),
      ...
      confirmSuccess(id, logType, index) {
        ...
        data._mt = 'sihfBenefitend.confirm'
        data.logType = 'logType'
        data.id = id
        data.sibeStatus = '30success'
        t.$Modal.confirm({
