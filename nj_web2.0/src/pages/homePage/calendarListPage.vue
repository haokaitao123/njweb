<template>
  <div class="background">
    ...
    <!--<el-dialog title="修改日程" width='600px' :visible.sync="changeEvent" @close="close">-->
      <div style="position: fixed;top: 0;left: 0;bottom: 0;right: 0;background: rgba(0,0,0,0.8);z-index: 3000" v-if="changeEvent">
        <div style="background: white;width:850px;position: absolute;margin-left: 300px;margin-top: 50px;">
          ...
          <addOrUpdate :dateShow="dateShow" ref="addOrUpdate"  :id="id" :state="state" @closechang="closechang" @rerender="rerender"></addOrUpdate>
        </div>
      </div>
