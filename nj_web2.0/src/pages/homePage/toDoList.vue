<template>
  <i-col class="col" span="8">
    <Card :bordered="false">
      ...
      <a href="#" slot="extra" @click="lookAllToDoList">
        <Icon type="more"></Icon>
      </a>
      <div class="block">
        <Spin fix v-if="isSpin"></Spin>
        <div class="block_row" v-for="(item, index) in toDoData" @click="doAnsrpt(item)">
          <Icon class="icon" type="document-text" color="#f33155"></Icon>
          <div class="div">
            {{item.todo_title}}
          </div>
        </div>
        <div class="block_row" v-for="(item, index) in approval" @click="doAnsrpt(item)">
          <Icon class="icon" type="document-text" color="#f33155"></Icon>
          <div class="div">
            {{item.apblTitlecn}}
          </div>
