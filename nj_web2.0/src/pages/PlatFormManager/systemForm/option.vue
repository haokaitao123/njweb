      ...
      >
        <i-col span="11">
          <FormItem :label="$t('lang_sysform.sysForm.sformCode')" prop="sformCode">
            <Input
              v-model="formValidate.sformCode"
              :placeholder="$t('lang_sysform.sysForm.p_sformCode')"
            ></Input>
          </FormItem>
        </i-col>
        <i-col span="11" offset="1">
          <FormItem :label="$t('lang_sysform.sysForm.sformName')" prop="sformName">
            <Input
              v-model="formValidate.sformName"
              :placeholder="$t('lang_sysform.sysForm.p_sformName')"
            ></Input>
          </FormItem>
        </i-col>
        <i-col span="11">
          <FormItem :label="$t('lang_sysform.sysForm.sformTbname')" prop="sformTbname">
            <Input
              v-model="formValidate.sformTbname"
        ...
        <i-col span="11" offset="1">
          <FormItem :label="$t('lang_sysform.sysForm.sformParentfield')" prop="sformParentfield">
            <Input
              v-model="formValidate.sformParentfield"
              :placeholder="$t('lang_sysform.sysForm.p_sformParentfield')"
            ></Input>
          </FormItem>
        </i-col>
        <i-col span="23">
          <FormItem :label="$t('lang_sysform.sysForm.sformAfthdClass')" prop="sformAfthdClass">
            <Input
              v-model="formValidate.sformAfthdClass"
              :placeholder="$t('lang_sysform.sysForm.p_sformAfthdClass')"
            ></Input>
          </FormItem>
        </i-col>
        <i-col span="23">
          <FormItem :label="$t('lang_sysform.sysForm.comment')" prop="comment">
            <Input
              ...
              :placeholder="$t('lang_sysform.sysForm.p_comment')"
            ></Input>
          </FormItem>
        </i-col>
      </Form>
    ...
    return {
      ...
      ruleValidate: {
        sformCode: [
          {
            required: true,
            message: this.$t("lang_sysform.sysForm.rule_sformCode"),
            trigger: "blur"
          }
        ],
        sformName: [
          {
            required: true,
            message: this.$t("lang_sysform.sysForm.rule_sformName"),
            trigger: "blur"
          }
        ],
        sformTbname: [
          {
            required: true,
            message: this.$t("lang_sysform.sysForm.rule_sformTbname"),
            trigger: "blur"
          }
        ]
      }
        ...
        .then(res => {
          if (isSuccess(res, t)) {
            ...
            this.formValidate.sformAfthdClass =
              res.data.content[0].sformAfthdClass;
            this.formValidate.sformParentfield =
              res.data.content[0].sformParentfield;
