      ...
      <card>
        ...
        <Row>
            <span @dblclick="clearPlatFlowcontactsid">
              <Input v-model="flvarFlowDis" icon="search" :readonly="true" :placeholder="$t('lang_platform.platFlowVar.flvarFlowIns')" style="width: 200px" @on-enter="enterEvent" @on-click="pickData" />
            </span>
          <Input :placeholder="$t('lang_platform.platFlowVar.flvarMarkIns2')" style="width: 200px" @on-enter="enterEvent" v-model="flvarMark"/>
