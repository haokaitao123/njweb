    ...
    data() {
      return {
        ...
        columns: [
          ...
          {
            title: this.$t('lang_selfdef.platCustoption.cptTablename'),
            key: 'cptTablename',
            sortable: 'custom',
          },
          {
            title: this.$t('lang_selfdef.platCustoption.cptFiele'),
            key: 'cptFiele',
            sortable: 'custom',
          },
          {
