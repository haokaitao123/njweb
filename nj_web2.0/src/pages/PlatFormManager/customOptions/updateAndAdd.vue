        ...
        <i-col class="meau-left" span="5">
          <Menu :active-name="active" width="auto" @on-select="pageTo">
            <MenuItem name="option">
              {{$t('lang_selfdef.platCustoption.title1')}}
            </MenuItem>
            <MenuItem name="content" v-show="id">
              {{$t('lang_selfdef.platCustoption.title2')}}
            </MenuItem>
          </Menu>
        </i-col>
  ...
  export default {
    data() {
      return {
        ...
        id: NaN,
        idname: '',
        title: this.$t('lang_selfdef.platCustoption.title1'),
        data: {
          _mt: 'platCustoption.getById',
          funId: '1',
        },
      }
    },
    ...
    methods: {
      ...
      getOption(id, logType) {
        ...
        this.title = this.$t('lang_selfdef.platCustoption.title1')
      },
      getid(id, name) {
        this.id = parseInt(id, 10)
        this.idname = name
      ...
      pageTo(name) {
        ...
        switch (name) {
          case 'content': this.title = this.$t('lang_selfdef.platCustoption.title2')
            break
          case 'option': this.title = this.$t('lang_selfdef.platCustoption.title1')
            break
        }
      },
      clear() {
