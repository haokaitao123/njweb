		...
		<div class="box">
			<div class="title">
		        <div class="title-text">
		        	<Icon type="mouse" size="16" style="margin-right: 10px;"></Icon>&nbsp;字段权限分配
		        </div>
			...
			<Row>
				<Col span="8" class="txtsize">可选择字段</Col>
				<Col span="15" offset="1" class="txtsize">已选择字段</Col>
			</Row>
