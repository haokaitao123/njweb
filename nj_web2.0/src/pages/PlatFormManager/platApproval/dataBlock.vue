<template>
  <div class="content-main">
    ...
    <row class="table-form" ref="table-form">
      <Table @on-selection-change="selectedtable" @on-sort-change="sortable" :height="410" size="small" border ref="selection" :columns="columns" :data="$store.state.platApproval.childTable6"></Table>
    </row>
          ...
          t.$Modal.confirm({
            ...
            onOk: () => {
              getDataLevelUserLogin({
                _mt: 'platAprvdatablock.delByIds',
                funId: '1',
                companyId: '1',
