    ...
    <Row style="max-height: 450px;overflow-y: auto;">
      <Form :model="form" label-position="right" :rules="ruleValidate" ref="form" :label-width="120">
        ...
        <FormItem :label="$t('lang_authorization.platRolecont.platRolecontCode')"  prop="platRolecontCode">
          <Input v-model="form.platRolecontCode" :placeholder="$t('lang_authorization.platRolecont.platRolecontCodeDis')" ></Input>
        </FormItem>
      </i-col>
        <i-col span="11" offset="1">
          <FormItem :label="$t('lang_authorization.platRolecont.platRolecontCnname')" prop="platRolecontCnname">
            <Input v-model="form.platRolecontCnname" :placeholder="$t('lang_authorization.platRolecont.platRolecontCnnameDis')" ></Input>
          </FormItem>
        </i-col>
        <i-col span="11">
        ...
        <i-col span="23">
          <FormItem :label="$t('lang_authorization.platRolecont.platRolecontDesc')" prop="platRolecontDesc">
            <Input v-model="form.platRolecontDesc" type="textarea" :autosize="{minRows: 2,maxRows: 5}" :placeholder="$t('lang_authorization.platRolecont.platRolecontDescDis')"></Input>
          </FormItem>
        </i-col>
        <i-col span="11" >
          <FormItem :label="$t('lang_authorization.platRolecont.platRolecontNotice')" prop="platRolecontNotice" >
            <Select v-model="form.platRolecontNotice" @on-change="selChangeNotice"  :placeholder="$t('lang_authorization.platRolecont.platRolecontNoticeDis')" :transfer="true">
              <Option :value="item.paramCode" v-for="(item,index) in tifymode" :key="index">{{item.paramInfoCn}}</Option>
            </Select>
          </FormItem>
        </i-col>
        <i-col span="11" offset="1" v-show="this.form.platRolecontNotice === '02all' ?false : true">
          <FormItem :label="$t('lang_authorization.platRolecont.platRolecontPhone')">
            <Input v-model="form.platRolecontPhone" :placeholder="$t('lang_authorization.platRolecont.platRolecontPhoneDis')" ></Input>
          </FormItem>
        </i-col>
        <i-col span="11"  v-show="this.form.platRolecontNotice === '02all' ?false : true">
          <FormItem :label="$t('lang_authorization.platRolecont.platRolecontSms')">
            <Input v-model="form.platRolecontSms" :placeholder="$t('lang_authorization.platRolecont.platRolecontSmsDis')" ></Input>
          </FormItem>
        </i-col>
        <i-col span="11" offset="1" v-show="this.form.platRolecontNotice === '02all' ?false : true">
          <FormItem :label="$t('lang_authorization.platRolecont.platRolecontUnifiedcn')">
            <Input v-model="form.platRolecontUnifiedcn" :placeholder="$t('lang_authorization.platRolecont.platRolecontUnifiedcnDis')" ></Input>
          </FormItem>
        </i-col>
        <i-col span="11" v-show="this.form.platRolecontNotice === '02all' ?false : true">
        ...
        <i-col span="11" offset="1" v-show="this.form.platRolecontNotice === '02all' ?false : true">
          <FormItem :label="$t('lang_authorization.platRolecont.platRolecontMail')">
            <Input v-model="form.platRolecontMail" :placeholder="$t('lang_authorization.platRolecont.platRolecontMailDis')" ></Input>
          </FormItem>
        </i-col>
        <i-col span="11"  :offset="offsetVal">
          <FormItem :label="$t('lang_authorization.platRolecont.platRolecontVaild')" >
            <RadioGroup v-model="form.platRolecontVaild" :placeholder="$t('lang_authorization.platRolecont.platRolecontVaildDis')">
        ...
        <i-col span="23">
        <FormItem :label="$t('lang_authorization.platRolecont.platRolecontNote')" prop="platRolecontNote">
          <Input v-model="form.platRolecontNote" type="textarea" :autosize="{minRows: 2,maxRows: 5}" :placeholder="$t('lang_authorization.platRolecont.platRolecontNoteDis')"></Input>
        </FormItem>
        </i-col>
      </Form>
    </Row>
