    ...
    <div class="box">
      <div class="title">
        <div class="title-text">
          <Icon type="mouse" size="16" style="margin-right: 10px;"></Icon>&nbsp;{{$t('lang_platform.platBenefitarea.distCompany')}}
        </div>
      ...
      <div>
        <Row>
          <i-col span="11" style="margin-bottom: 10px;">
            <span style="font-size: 14px;color: #495060">{{$t('lang_platform.platBenefitarea.selectCompany')}}</span>
          </i-col>
          <i-col span="11" style="margin-bottom: 10px;" offset="1">
            <span style="font-size: 14px;color: #495060">{{$t('lang_platform.platBenefitarea.selectedCompany')}}</span>
          </i-col>
          <i-col span="11">
  ...
  export default {
    data() {
      return {
        ...
        columns1: [{
          ...
          {
            title: this.$t('lang_platform.platBenefitarea.companyName'),
    ...
    methods: {
      getClumns1(id) {
        ...
        getDataLevelUserLogin({
          _mt: 'platBenefitareaCompany.getListByAreId',
          id: id,
      ...
      saveClumns1() {
        ...
        const field = t.data2.map(item => {
          return item.bfacompCompid
        })
        getDataLevelUserLoginNew({
          _mt: 'platBenefitareaCompany.addByCompanyIds',
          bfacompAreaid: t.id,
          bfacompCompid: field.join(),
