    ...
    <div class="box">
      ...
      <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="135">
        <Row>
          ...
          <FormItem :label="$t('lang_platform.platEmpno.empno')" prop="empno">
            <Input v-model="formValidate.empno" :placeholder="$t('lang_platform.platEmpno.empnoDis')"></Input>
          </FormItem>
          </Col>
          <Col span="10" offset="1">
        ...
        <Row>
          <Col span="10" offset="1">
          <FormItem :label="$t('lang_platform.platEmpno.validName')" prop="valid">
            <Select v-model="formValidate.valid" :placeholder="$t('lang_platform.platEmpno.validNameDis')">
