  ...
  <div class="table">
    <Row>
      ...
      <card>
        ...
        <Row>
          <Input :placeholder="$t('lang_platBusirel.platBusirel.p_platSerConperson')" style="width: 200px" v-model="platSerConperson"/>
          <Input :placeholder="$t('lang_platBusirel.platBusirel.platSerTeam')" style="width: 200px" v-model="platSerTeam"/>
          <Input :placeholder="$t('lang_platBusirel.platBusirel.platSerRange')" style="width: 200px" v-model="platSerRange"/>
...
<script>
  ...
  export default{
    data() {
      return {
        tableheight: document.body.offsetHeight - 265,
        value: '',
        logType: '',
        openUpdate: false,
        updateId: NaN,
