<template>
  <div class="useInfoMain">
    <Form ref="formValidate" class="form" :model="formValidate" :rules="ruleValidate" :label-width="135">
      <div v-show="!isEmpty" style="position:relative;">
        <img src="../../../static/img/sky.png" height="140" width="833">
        <Button icon="chevron-left" type="text" @click="back" class="backBtn">返回</Button>
        <div class="header-box">
          <div class="header-cover" @click="render1">点击上传头像</div>
            <div class="header">
              <img :src="cropedImg===''?'../../../static/img/header1.png':cropedImg" width="100" height="100">
            </div>
      ...
      <Row style="margin-top:20px;">
        <i-col span="10" offset="1">
          <FormItem label="手机号" prop="mobileNo">
            <Input v-model="formValidate.mobileNo" placeholder="请输入手机号"></Input>
          </FormItem>
        </i-col>
        <i-col span="10" offset="1">
          <FormItem label="出生日期" prop="birthDate">
            <DatePicker type="date" placeholder="选择出生日期" :editable="false" v-model="formValidate.birthDate" style="width: 100%"></DatePicker>
          </FormItem>
        </i-col>
      </Row>
      <Row>
        ...
        <i-col span="10" offset="1">
          <FormItem label="性别" prop="gender">
            <Select v-model="formValidate.gender"  placeholder="选择性别">
      ...
      <Row>
        <i-col span="10" offset="1">
          <FormItem label="证件类型" prop="idType">
            <Select v-model="formValidate.idType"  placeholder="选择证件类型">
      ...
      <Row>
        <i-col span="10" offset="1">
          <FormItem label="身份证号码" prop="idNo">
            <Input v-model="formValidate.idNo" placeholder="请输入身份证号码"></Input>
          </FormItem>
        </i-col>
      </Row>
      <Row>
    ...
    <changePhone v-show="showPhone" @closePhone="closePhone" ref="changePhone"></changePhone>
    <changePassWord v-show="showPassWord" @closePassWord="closePassWord" ref="changePassWord"></changePassWord>
  </div>
</template>
<script>
...
.backBtn{position:absolute; right: 10px; top: 10px; color: #fff; font-size: 14px;}
</style>
