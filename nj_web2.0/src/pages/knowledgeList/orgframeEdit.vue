	...
	<div class="cover">
		<div class="box">
					...
					<Form ref="form" :label-width="120" :model="form" :rules="ruleValidate">
						<i-col span="22" offset="1">
							...
							<div class="adds" v-show="addShow">
								<Row>
									<Col span="11">
									<FormItem label="类目名称:" prop="claName">
										<span>
											<Input placeholder="请输入类目名称" :disabled='disabled' :maxLength=100 v-model="form.claName" />
										</span>
									</FormItem>
									</Col>
									<Col span="11" offset="1">
									<FormItem label="知识类目id" prop="operatId">
										<span>
											<Input placeholder="请输入知识类目id" :disabled='disabled' v-model="form.operatId" />
										</span>
									</FormItem>
									</Col>
								</Row>
								<Row>
									...
									<FormItem label="排序" prop="sorts">
										<span>
											<Input placeholder="请输入排序" :disabled='disabled' v-model="form.sorts" />
										</span>
									</FormItem>
									</Col>
									<Col span="11" offset="1">
									<FormItem label="父级id" prop="fatherId">
										<span>
											<Input placeholder="请输入父id" :disabled='disabled' v-model="form.fatherId" />
										</span>
									</FormItem>
									</Col>
								</Row>
								<Row>
									<Col span="11">
									<FormItem label="所属部门" v-if="this.form.phone == '是'" prop="department">
										<span @dblclick="disabled ? '' : cleardeptId()">
											<Input v-model="form.department" icon="search" :disabled="disabled" :readonly="true" placeholder="选择部门"
								...
								<Col span="11" >
									<FormItem label="所属部门"  v-if="this.form.phone == '否'" >
										<span @dblclick="disabled ? '' : cleardeptId()">
											<Input v-model="form.department" icon="search" :disabled="disabled" :readonly="true" placeholder="选择部门"
											 @on-click="disabled ? '' : pickDeptData()" />
										</span>
								...
								<Row>
									<Col span="11">
									<FormItem label="是否通用" prop="phone">
							...
							<div class="addContent" v-show="addconShow">
								<Row>
									...
									<FormItem label="标题" prop="title">
										<span>
											<Input placeholder="请输入标题" :readonly="true" :disabled='disabled' v-model="form.title" />
										</span>
									</FormItem>
									</Col>
								</Row>
								...
								<div class="adds">
									<Row>
										<Col span="11">
										<FormItem label="所属类目id" prop="categoryId">
											<span>
												<Input placeholder="请输入类目id" :disabled='disabled' :maxLength=100 v-model="form.categoryId" />
											</span>
										</FormItem>
										</Col>
										<Col span="11" offset="1">
										<FormItem label="结束时间" prop="expired">
											<span>
												<DatePicker type="date" placeholder="请输入结束时间" v-model="form.expired" style="width: 200px"></DatePicker>
											</span>
										</FormItem>
										</Col>
									</Row>
									<Row>
										<Col span="11">
										<FormItem label="操作人id" prop="count">
											<span>
												<Input placeholder="请输入操作人id" :disabled='disabled' v-model="form.count" />
											</span>
										</FormItem>
										</Col>
										<Col span="11" offset="1">
									...
									<Row>
										...
										<Col span="11" offset="1">
											<FormItem label="知识id" prop="tag">
												<span>
													<Input placeholder="请输入知识id" :disabled='disabled' v-model="form.tag" />
												</span>
											</FormItem>
										</Col>
									</Row>
			...
			<transition name="fade">
				<searchDept v-show="openDeptPick" :searchDeptClo="searchDeptCloumns" :params="deptParams" @closeDept="closeDept"
				 @inputDept="changeDeptInput" v-on:showData="getLists" ref="searchDept"></searchDept>
			</transition>
		</div>
	</div>
</template>
