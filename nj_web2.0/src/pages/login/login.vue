                ...
                <Form ref="loginForm"
                    ...
                    <FormItem prop="noteCode"
                        ...
                        <Row>
                            ...
                            <span v-show="noteCodeFlag"
                                  style="position: absolute;top: 28px;left: 0;color:#ed3f14;">验证码输入有误</span>
                            </Col>
                            <Col span="9"
                                 offset="2">
                            <div class="noteCode"
...
<script>
import { getNoteCode, getDataLevelNone, getNoteCodeFirst } from '../../axios/axios'
