      ...
      <Row>
        ...
        >
          ...
          <i-col span="11" offset="1">
            <FormItem label="试用期限" prop="contSigndate">
              <Input v-model="form.contSigndate" placeholder="请输入试用期限"></Input>
            </FormItem>
          </i-col>
          <i-col span="23">
            ...
            <FormItem label="工作制度" prop="contWorktime">
          ...
          <i-col span="24">
            ...
            <!-- <i-col span="23"></i-col> -->
            <i-col span="11">
              <FormItem label="合同开始日" prop="conSdate">
                <DatePicker
                  type="date"
                  placeholder="请选择开始日期"
                  style="width: 100%"
                  :editable="false"
                  v-model="form.conSdate"
                ></DatePicker>
              </FormItem>
            </i-col>
            <i-col span="11" offset="1">
              <FormItem label="结束时间" prop="conEdate">
                <DatePicker
                  type="date"
                  placeholder="请选择结束日期"
                  style="width: 100%"
                  :editable="false"
                  v-model="form.conEdate"
                ></DatePicker>
              </FormItem>
            </i-col>
            <i-col span="23">
  ...
  data() {
    return {
      ...
      ruleValidate: {
        ...
        contSigndate: [{ required: true, message: "请输入试用期限", trigger: "blur" }],
        contWorktime: [
          { required: true, message: "请输入工作制度", trigger: "change" }
        ],
        conSdate: [
          {
            required: true,
