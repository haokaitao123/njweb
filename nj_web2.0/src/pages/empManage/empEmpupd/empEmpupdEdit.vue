          ...
          <Form ref="form" :model="form" :rules="ruleValidate" :label-width="120">
            ...
            <i-col span="11">
              <FormItem label="证件号码" prop="empnhIdno">
                <Input v-model="empnhIdno" disabled="disabled" placeholder="请输入证件号码"/>
              </FormItem>
            </i-col>
            <i-col span="11" offset="1">
              <FormItem label="居住地址" prop="empupdResaddr">
                <Input v-model="form.empupdResaddr" :disabled="disabled" placeholder="请输入居住地址"/>
              </FormItem>
            </i-col>
            <i-col span="11">
                    <FormItem label="开户银行"
            ...
            <i-col span="11" offset="1">
              <FormItem label="银行账号" prop="empupdSalcount">
                <Input v-model="form.empupdSalcount" :disabled="disabled" placeholder="请输入银行账号"/>
              </FormItem>
            </i-col>
            <i-col span="11">
              <FormItem label="户名" prop="empupdSalcname">
                <Input v-model="form.empupdSalcname" :disabled="disabled" placeholder="请输入户名"/>
              </FormItem>
            </i-col>
            <i-col span="22" offset="1">
              <FormItem label="未通过原因" prop="empupdReason">
                <Input v-model="form.empupdReason" :disabled="disabled" type="textarea" :autosize="{minRows: 2,maxRows: 5}" placeholder="请输入未通过原因"/>
              </FormItem>
            </i-col>
            <i-col span="22" offset="1">
