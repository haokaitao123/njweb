    ...
    <div class="backbox">
      <div class="title">
        <div class="title-text">
          <Icon type="mouse" size="16" style="margin-right: 10px;"></Icon>&nbsp;{{$t('lang_evaluation.evaluation.diagObject1')}}
        </div>
      ...
      <Row class="table-form">
        <Input :placeholder="$t('lang_evaluation.evaluation.resYear1Ins')" style="width: 200px" v-model="pmtypeCode"/>
