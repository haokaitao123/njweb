        ...
        <Row style="overflow-x:scroll;overflow-y: hidden;  ">
          <div class="echats"  style="min-width:1088px; overflow-y:scroll" :style="{height:tableheight + 'px'}">
            <i-col span="20" style="width: 33.333% !important;height: 600px;border: 2px solid #F0F0F0;padding: 10px;box-sizing: border-box" >
              <article style="height: 40px;line-height: 30px;border-bottom: 1px solid #ccc;">{{$t('lang_evaluation.evaluation.title4')}}
</article>
            ...
            <i-col span="20" style="width: 33.333% !important;height: 600px;border: 2px solid #F0F0F0;padding: 10px;box-sizing: border-box">
              	<article style="height: 40px;line-height: 30px;border-bottom: 1px solid #ccc;">{{$t('lang_evaluation.evaluation.title6')}}
</article>
	              <div style="width: 100%;padding-top: 10px;padding-bottom: 20px;overflow:hidden">
...
<script>
  ...
  export default{
    ...
    mounted() {
      this.year = 2016
      this.planOfDiagnosis = this.$t('lang_evaluation.evaluation.zh5')
      this.resEmpidDis = this.$t('lang_evaluation.evaluation.zh6')
      this.indName = this.$t('lang_evaluation.evaluation.zh7')
      this.resEmpidDis1 = this.$t('lang_evaluation.evaluation.zh8')
      this.proId1 = '1019'
      this.indId = '1150'
      this.resEmpid = '88'
      this.resEmpid1 = '1023'
