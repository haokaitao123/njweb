<template>
  <div class="table">
    <Row>
      ...
      <card>
        <p slot="title">
          ...
          &nbsp;{{$t('lang_knowBase.knowlegebase.title5')}}
        </p>
        <Row>
    ...
    <transition name="fade">
      <update v-show="openUpdate" :knowledgeStatus="knowledgeStatus" :Knowauthtype="Knowauthtype" :yesno="yesno" :knowledgeType="knowledgeType" :id="updateId" ref="update" :logType="logType" :index="index" @closeUp="closeUp" @getData="addNewArray" @update="updateArray"></update>
    </transition>
  </div>
</template>
<script>
