    ...
    <Row>
      ...
      <card>
        <p slot="title">
          ...
          &nbsp;{{$t('lang_knowBase.knowlegeType.title')}}
        </p>
        <Row>
        	...
        	<i-col span="20" style="width: 83.3333% !important">
        		<Row>
		          <Input :placeholder="$t('lang_knowBase.knowlegeType.searchText')" style="width: 200px" v-model="cmutKntypeCode"/>
    ...
    data() {
      return {
        ...
        columns: [
          ...
          {
            title: this.$t('lang_knowBase.knowlegeType.cmutKntypePid'),
            key: 'cmutKntypePidDis',
          },
          {
            title: this.$t('lang_knowBase.knowlegeType.cmutKntypeDesc'),
            key: 'cmutKntypeDesc',
//            sortable: 'custom',
//            width: 150,
          },
