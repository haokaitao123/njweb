      ...
      <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="135" style="height: 500px;overflow-y: auto;padding: 5px;">
        ...
        <Row>
          ...
          <FormItem :label="$t('lang_knowBase.knowlegebase.cmutKldOrder')" prop="cmutKldAuth">
            <RadioGroup disabled v-model="formValidate.cmutKldAuth"  :placeholder="$t('lang_knowBase.knowlegebase.cmutKldOrder')" transfer>
        ...
        <Row>
          ...
          <FormItem :label="$t('lang_knowBase.knowlegebase.cmutKldOrder')" prop="cmutKldNote">
            <Input v-model="formValidate.cmutKldNote"  disabled type="textarea" :autosize="{minRows: 2,maxRows: 5}" :placeholder="$t('lang_knowBase.knowlegebase.cmutKldOrder')"></Input>
          </FormItem>
          </Col>
        </Row>
      </Form>
