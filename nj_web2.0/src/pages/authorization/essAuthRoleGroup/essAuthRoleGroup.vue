  ...
  <div class="table">
    <Row>
      ...
      <card>
        ...
        <Row>
          <Input :placeholder="$t('lang_role.admingrprole.prolegrpCode')" style="width: 200px" @on-enter="enterEvent" v-model="rolegrpCode"/>
          <Input :placeholder="$t('lang_role.admingrprole.prolegrpCname')" style="width: 200px" @on-enter="enterEvent" v-model="rolegrpCname"/>
