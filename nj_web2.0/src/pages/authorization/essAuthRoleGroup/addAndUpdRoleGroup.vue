      ...
      <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="135">
        <Row>
          ...
          <FormItem :label="$t('lang_role.admingrprole.rolegrpCode')" prop="rolegrpCode">
            <Input v-model="formValidate.rolegrpCode" :placeholder="$t('lang_role.adminpmtype.rolegrpCode')"
                   ></Input>
          </FormItem>
          </Col>
          <Col span="10" offset="1">
          <FormItem :label="$t('lang_role.admingrprole.rolegrpCname')" prop="rolegrpCname">
            <Input v-model="formValidate.rolegrpCname" :placeholder="$t('lang_role.adminpmtype.pprolegrpCname')"
                 ></Input>
          </FormItem>
          </Col>
        </Row>
        <Row>
          ...
          <FormItem :label="$t('lang_role.admingrprole.rolegrpEname')" prop="rolegrpEname">
            <Input v-model="formValidate.rolegrpEname" :placeholder="$t('lang_role.adminpmtype.prolegrpEname')"
                   ></Input>
          </FormItem>
          </Col>
          <Col span="10" offset="1">
        ...
        <Row>
          ...
          <FormItem :label="$t('lang_role.admingrprole.rolegrpDesc')"  prop="rolegrpDesc">
            <Input v-model="formValidate.rolegrpDesc" type="textarea" :autosize="{minRows: 2,maxRows: 5}"
                   :placeholder="$t('lang_role.rootgrprole.prolegrpDesc')" ></Input>
          </FormItem>
          </Col>
        </Row>
        ...
        <Row v-show="openInValid">
          ...
          <FormItem :label="$t('lang_role.rootrole.invreason')" prop="invreason">
            <Input v-model="formValidate.invreason" type="textarea" :placeholder="$t('lang_role.rootrole.pinvreason')"
