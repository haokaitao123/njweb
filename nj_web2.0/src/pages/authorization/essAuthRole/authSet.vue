<template>
  <div>
    <Row>
      ...
      <Tabs type="card" value="name0">
        <TabPane :label="$t('lang_role.adminrole.flagBox')" style="height:450px;"
                 :disabled="flagBox.funIsctrlbtn !== '1'" name="name1">
        ...
        <TabPane :label="$t('lang_role.adminrole.plalist')" name="name2" :disabled="flagBox.funIsform !== '1'" style="height:450px;">
          <Row>
            ...
            <i-col span="8">
              <Table border :columns="columns1" @on-selection-change="selectColumn1" :data="data1"
                     :height="375"></Table>
            </i-col>
        ...
        <TabPane :label="$t('lang_role.adminrole.flagBox2')" name="name3" :disabled="flagBox.funIsform !== '1'" style="height:450px;">
          <Row>
            <i-col span="23" style="margin-bottom: 10px;">
              <Button type="primary" @click="saveColumn3">{{$t('button.sav')}}</Button>
            </i-col>
            <i-col span="8" style="margin-bottom: 10px;">
              <span style="font-size: 14px;color: #495060">{{$t('lang_role.adminrole.Optional')}}</span>
            </i-col>
            ...
            <i-col span="8">
              <Table border :columns="columns3" :data="data3" @on-selection-change="selectColumn3"
                     :height="375"></Table>
            </i-col>
            <i-col span="1" class="btnFa">
              <ButtonGroup vertical size="small">
                <Button type="ghost" size="small" icon="chevron-up" @click="toMove(3)"></Button>
                <Button type="ghost" size="small" icon="chevron-right" @click="toRight(2)"></Button>
                <Button type="ghost" size="small" icon="chevron-left" @click="toLeft(2)"></Button>
                <Button type="ghost" size="small" icon="chevron-down" @click="toMove(4)"></Button>
              </ButtonGroup>
            </i-col>
            <i-col span="15">
              <Table border :columns="columns4" :data="data4" :height="375" @on-selection-change="optRight2"
        ...
        <TabPane :label="$t('lang_role.adminrole.flow')" style="position:relative;height:450px;" :disabled="flagBox.funIsprocess !== '1'"
          ...
          <div v-if="flagBox.funIsprocess === '1'">
            ...
            <div v-else>
              ...
              <div style="height: 400px;overflow-y: auto;width: 100%;padding:0 10px;">
  ...
  export default {
    data() {
      return {
        ...
        data4: [],
        params: {
          _mt: 'sysESSMSSAgwService.selPartSysFunctionsByTree',
          funType: '1admin',
        },
