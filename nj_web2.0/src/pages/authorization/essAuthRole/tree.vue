<template>
    <div class="cover">
        <div class="box">
            ...
            <Tabs value="name1">
                <TabPane :label="$t('lang_role.adminrole.placfun')"
                         name="name1">
                    <Row>
                        <Col class="col"
                             span="4">
                ...
                <TabPane :label="$t('lang_role.adminrole.placauthset')"
                         name="name2"
                         :disabled='disabled'>
                    <authSet :id="id"></authSet>
                </TabPane>
                <TabPane :label="$t('lang_role.adminrole.pletodo')"
                         name="name3">
...
export default {
    data () {
        return {
            ...
            disabled: true,
            params: {
                _mt: 'sysESSMSSAgwService.selSysFunctionsByTree',
                funType: '1admin',
            },
        }
    },
            ...
            getDataLevelUserLoginNew(data).then((res) => {
                if (isSuccess(res, t)) {
                    if (res.data.content[0]) {
                        ...
                        for (let k of res.data.content[0].value) {
                            if (k.authRoleFunDis === '1') {
                                t.disabled = false
                            }
                        }
