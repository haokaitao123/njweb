    ...
    <div class="cover">
        <div class="box"
            ...
            <Tabs @on-click="getBtnData"
                  v-model="name">
                <TabPane :label="$t('lang_role.adminfun.TabPane')"
                         name="sys1">
                    <Form class="tab-box"
                          ref="formValidate"
                          :model="formValidate"
                        ...
                        <Row>
                            ...
                            <FormItem label="功能编码"
                                      prop="funLancode"
                                      :label-width="135">
                                <Input v-model="formValidate.funLancode"
                                       placeholder="请输入功能编码"></Input>
                            </FormItem>
                            </Col>
                            <Col span="11">
                            <FormItem :label="$t('lang_role.adminfun.funName')"
                                      prop="funName"
                                      :label-width="135">
                                <Input v-model="formValidate.funName"
                                       :placeholder="$t('lang_role.adminfun.pfunName')"></Input>
                            </FormItem>
                            </Col>
                            <Col span="11"
                                 offset="1">
                            ...
                            <Col span="11"
                                 v-show="formValidate.funStyle ==='03state'"
                                 offset="1">
                            <FormItem label="状态编码"
                                      :label-width="135">
                                <Input v-model="formValidate.funStatecode"
                                       placeholder="请输入状态编码"></Input>
                            </FormItem>
                            </Col>
                            <Col span="11"
                                 v-show="formValidate.funStyle ==='03state'">
                            <FormItem label="是否默认状态"
                                      prop="funIsdefault"
                                      :label-width="135">
                                <RadioGroup v-model="formValidate.funIsdefault">
                            ...
                            <!-- :offset="formValidate.funIsprocess ==='0' ? 0 : 0" -->
                            <Col span="11"
                                 offset="1"
                            ...
                            <!-- :offset="formValidate.funIsprocess ==='0' && formValidate.funIsform ==='1'   ? 1 : 0 " -->

                            <Col span="11"
                                 :offset="formValidate.funIsprocess ==='0' && formValidate.funIsform ==='1'   ? 0 : 1 "
                            ...
                            <Col :span="formValidate.funIsprocess ==='0' && formValidate.funIsform ==='1' ? 11 : 22"
                                 :offset="formValidate.funIsprocess ==='0' && formValidate.funIsform ==='1' ? 1 : 0">
                    ...
                    <div class="tab-btn">
                        <Button type="ghost"
                                @click="handleReset"
                                style="margin-ri: 8px">{{$t('button.cal')}}</Button>
                        <Button type="primary"
                                @click="handleSubmit">{{$t('button.sav')}}</Button>
                    </div>
                </TabPane>
                <TabPane :label="$t('lang_role.adminfun.TabPane2')"
                         name="sys2"
...
export default {
    ...
    methods: {
        getData (id) {
            ...
            getDataLevelUserLogin({
                ...
                if (isSuccess(res, t)) {
                    ...
                    t.formValidate.funIsdefault = res.data.content[0].value[0].funIsdefault
        ...
        clearDub4 () {
            const t = this
            t.formValidate.funStatecode = ''
            t.formValidate.funIsdefault = '0'
        },
        ...
        getSelect () {
            ...
            getDataLevelUserLogin({
                ...
                if (isSuccess(res, t)) {
                    ...
                    console.log(t.selectFunStyle, "selectFunStyle")
                }
            }).catch(() => {
                this.$Modal.error({
                    title: this.$t('reminder.err'),
