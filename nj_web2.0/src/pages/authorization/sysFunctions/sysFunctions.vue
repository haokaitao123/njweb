<template>
  <div class="table">
      ...
      <card>
        ...
        <Row>
          <span @dblclick="clearDub">
            <Input v-model="funPidDis" icon="search" :readonly="true" :placeholder="$t('lang_role.adminfun.pfunPidDis')"
                   style="width: 200px"
                   @on-click="pickData"/>
          </span>
    ...
    <transition name="fade">
      <update v-show="openUpdate" :id="updateId" ref="update" :logType="logType" :index="index" @closeUp="closeUp"
              @getData="addNewArray" @update="updateArray"></update>
    </transition>
    <transition name="fade">
