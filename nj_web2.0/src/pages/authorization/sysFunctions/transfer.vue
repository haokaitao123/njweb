    ...
    <div class="box" style="width: 460px">
      ...
      <Transfer
        ...
        <div :style="{float: 'right', margin: '5px'}">
          <Button type="ghost" size="small" @click="upMove">{{$t('lang_role.adminfun.upMove')}}</Button>
          <Button type="ghost" size="small" @click="downMove">{{$t('lang_role.adminfun.downMove')}}</Button>
        </div>
      </Transfer>
