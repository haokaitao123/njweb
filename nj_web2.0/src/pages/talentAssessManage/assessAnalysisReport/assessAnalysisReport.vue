      ...
      <card style="margin: 0">
        ...
        <Row style="overflow-x:scroll;overflow-y: hidden;  ">
          <div class="echats"  style="min-width:1088px; overflow-y:scroll" :style="{height:tableheight + 'px'}">
            <i-col span="20" style="width: 33.333% !important;height: 500px;border: 2px solid #F0F0F0;padding: 10px;box-sizing: border-box">
              ...
              <div style="width: 100%;padding-top: 10px;padding-bottom: 20px;overflow:hidden">
              	<span style="padding:0;margin:0;display: inline-block;" class="fl_block1">
              		{{$t('lang_evaluation.evaluation.resYear2')}}<Input v-model="year"  :placeholder="$t('lang_evaluation.evaluation.resYear2Ins')" style="margin-left:20px;width: 150px;"></Input>
              	</span>
                	<Button type="primary" @click="search1" style="" class="rt_block1">{{$t('button.ser')}}</Button>
			          <span @dblclick="clearPlanData" style="padding:0;display: inline-block;" class="fl_block2">
			                {{$t('lang_evaluation.evaluation.planOfDiagnosis1')}}<Input :placeholder="$t('lang_evaluation.evaluation.resEmpSchemeNameIns2')" icon="search" :readonly="true" v-model="planOfDiagnosis" @on-click="pickPlanData" style="margin-left:20px;width:150px;"/>
			          </span>
            ...
            <i-col span="20" style="width: 33.333% !important;height: 600px;border: 2px solid #F0F0F0;padding: 10px;box-sizing: border-box">
              ...
              <div style="width: 100%;padding-top: 10px;padding-bottom: 20px;overflow:hidden">
              	<span @dblclick="clearDiagData" style="padding:0;margin:0;display: inline-block;" class="fl_block1">
              		{{$t('lang_evaluation.evaluation.resEmpid1Dis2')}}<Input v-model="resEmpidDis"  :placeholder="$t('lang_evaluation.evaluation.resEmpidDis1Ins2')" icon="search" :readonly="true" @on-click="pickDiagObject" style="margin-left:20px;width: 150px;"></Input>
              	</span>
            ...
            <i-col span="20" style="width: 33.333% !important;height: 600px;border: 2px solid #F0F0F0;padding: 10px;box-sizing: border-box">
              	...
              	<span @dblclick="clearDiagData1" style="padding:0;margin:0;display: inline-block;" class="fl_block1">
              		{{$t('lang_evaluation.evaluation.resEmpidDis5')}}<Input v-model="resEmpidDis1"  :placeholder="$t('lang_evaluation.evaluation.resEmpidDis5Ins')" icon="search" :readonly="true" @on-click="pickDiagObject1" style="margin-left:20px;width: 150px;"></Input>
              	</span>
