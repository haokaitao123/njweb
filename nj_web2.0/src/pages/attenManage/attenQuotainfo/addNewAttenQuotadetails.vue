    ...
    <div class="box">
      ...
      <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="135">
        <Row>
          ...
          <!--  员工姓名选择框  -->
          <Col span="11">
            <FormItem label="配额类型" prop="quoType">
              <Select
                v-model="formValidate.quoType"
                class="width200"
                :disabled="disabled"
                placeholder="请选择配额类型"
              >
                <Option
                  v-for="(item, index) in selectAttenType"
          ...
          <Col span="11" offset="1">
            <FormItem label="配额日期" prop="quoTime">
              <DatePicker
                type="date"
                :disabled="disabled"
                :readonly="disabled"
        ...
        <Row>
          <Col span="11">
            <FormItem label="配额天数" prop="quoDay">
              <Input
                v-model="formValidate.quoDay"
                :disabled="disabled"
                placeholder="请输入配额天数"
                style="width: 100%"
              ></Input>
