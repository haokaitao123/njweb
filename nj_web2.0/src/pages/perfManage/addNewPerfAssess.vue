<template>
    <div class="cover">
                ...
                <Row style="max-height: 420px;overflow-y: auto;"
                    ...
                    <Form ref="formValidate"
                        ...
                        <i-col span="11">
                            <FormItem label="扣款金额"
                                      prop="asesAmount">
                                <Input v-model="formValidate.asesAmount"
                                       :disabled="forbidden"
                                       placeholder="请输入扣款金额">></Input>
                            </FormItem>
                        </i-col>
                        <i-col span="11">
                            <FormItem label="扣款日期"
        ...
        <transition name="fade">
            <searchPerfIndicators v-show="openPick"
                                  @closePerf="closePerf"
                                  @inputPerf="inputPerf"
                                  ref="searchPerfIndicators"></searchPerfIndicators>
        </transition>
    </div>
</template>
<script>
