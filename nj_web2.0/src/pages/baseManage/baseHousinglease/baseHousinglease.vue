    ...
    <Row>
      <Col span="24">
        <card>
          ...
          <Row>
            扣除年度：
            <Input placeholder="扣除年度" v-model="leaseYear" style="width: 120px;"/>扣除金额：
            <Input placeholder="扣除金额" v-model="leaseAmout" style="width: 120px;"/>
            <span style="margin: 0;">
