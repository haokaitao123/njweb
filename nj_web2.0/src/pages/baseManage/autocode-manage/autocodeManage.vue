  ...
  <div class="table">
    <Row>
      ...
      <card>
        ...
        <Row>
          <Input :placeholder="$t('lang_baseManage.autocode.autoFlagIns')" style="width: 200px" v-model="autoFlag"/>
          <Input :placeholder="$t('lang_baseManage.autocode.autoNameIns')" style="width: 200px" v-model="autoName"/>
