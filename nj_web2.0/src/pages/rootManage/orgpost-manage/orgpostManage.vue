            ...
            <Col span="18" style="width: 100% !important">
              <Row>
                <Input
                  ...
                  v-model="postFname"
                />
                <Select v-model="postDfpslevel" style="width: 200px" placeholder="请选择职位级别">
                  <Option
...
export default {
  data() {
    return {
      ...
      searchCloumns: [
                {
                    title: this.$t("lang_organization.orgframe.postCode"),
                    key: "postCode",
                    sortable: "custom"
                },
          ...
          h(
            ...
            [
              h("Icon", {
                props: {
                  type:
                    data.postType === "01company"
                      ? "social-buffer"
                      : data.postType === "02dept"
                      ? "ios-people"
                      : "person",
                  size:
                    data.postType === "01company"
