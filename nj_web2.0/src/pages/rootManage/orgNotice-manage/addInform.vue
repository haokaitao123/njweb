        ...
        <Row style="max-height: 420px;overflow-y: auto;"
         ...
         >
          <Row>
            <Col span="10">
              <!-- prop为要传入的字段 -->
              <FormItem label="生效日期" prop="noticePublish">
                <DatePicker
                  type="date"
          ...
          <Row>
            <Col span="23">
              <FormItem label="标题" prop="noticeTitle">
                <Input v-model="form.noticeTitle" :disabled="editdisabled" placeholder="请输入标题"></Input>
              </FormItem>
            </Col>
          </Row>
      ...
      <Row style="margin-top:20px;">
        <Col span="22" offset="1">
          <Row type="flex" justify="end">
            <!-- 取消按钮 -->
            <Button type="ghost" @click="handleReset" style="margin-right: 8px">取消</Button>
            <!-- 保存按钮 -->
    ...
    handleSubmit() {
      ...
      t.$refs.form.validate(valid => {
        if (valid) {
          ...
          t.form.noticePublish = t.form.noticePublish.format("yyyy-MM-dd"); //  获取失效日期
