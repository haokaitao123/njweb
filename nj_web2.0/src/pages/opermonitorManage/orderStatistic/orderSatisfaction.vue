    ...
    <Row>
      ...
      <card>
        <p slot="title">
          ...
          &nbsp;{{$t('lang_operatmonitor.orderCountStatistic.title2')}}
        </p>
        <Row>
...
//            sortable: 'custom',
          ...
          {
            title: this.$t('lang_operatmonitor.orderCountStatistic.allOrder'),
            key: 'allOrder',
          },
          {
            title: this.$t('lang_operatmonitor.orderCountStatistic.dealingNum'),
            key: 'dealingNum',
          },
          {
            title: this.$t('lang_operatmonitor.orderCountStatistic.avgEvaluate'),
            key: 'avgEvaluate',
          },
        ],
        //      雇佣公司
    ...
    methods: {
      getData(page) {
        ...
        const data = {
          _mt: 'ansrptCmutWorkoerder.getOrderCount',
          sort: t.sort,
          order: t.order,
          rows: t.rows,
          page: t.page,
