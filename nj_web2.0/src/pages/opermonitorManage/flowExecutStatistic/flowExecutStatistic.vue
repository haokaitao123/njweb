    ...
    <Row>
      ...
      <card>
        <p slot="title">
          ...
          &nbsp;{{$t('lang_operatmonitor.flowBusinesStatistic.title2')}}
        </p>
        <Row>
  ...
  export default{
    data() {
      return {
        ...
        columns: [
          ...
          {
            title: this.$t('lang_operatmonitor.flowBusinesStatistic.avgdealtime'),
            key: 'avgdealtime',
          },
          {
            title: this.$t('lang_operatmonitor.flowBusinesStatistic.mindealtime'),
            key: 'mindealtime',
          },
          {
            title: this.$t('lang_operatmonitor.flowBusinesStatistic.maxdealtime'),
            key: 'maxdealtime',
          },
        ],
        data: [],
    ...
    methods: {
      getData(page) {
        ...
        const data = {
          _mt: 'ansrptFlowStatistic.getFlowStepStatisticPage',
          sort: t.sort,
          order: t.order,
          rows: t.rows,
          page: t.page,
