    ...
    <div class="backbox">
      <div class="title">
        <div class="title-text">
          <Icon type="mouse" size="16" style="margin-right: 10px;"></Icon>&nbsp;{{$t('lang_evaluation.evaluation.diagObject')}}
        </div>
      ...
      <Row class="table-form">
        <Input :placeholder="$t('lang_evaluation.evaluation.pmtypeCode')" style="width: 200px" v-model="pmtypeCode"/>
    ...
    methods: {
      ...
      getData() {
        ...
        const data = {
	      ...
	      sort: t.sort,
	      order: t.order,
	      logType: '雇佣公司', unitsFname: t.pmtypeCode,
	      unitType: '01company',
        }
      ...
      dbCkick(row) {
        const t = this
        this.$emit('changeinputDiag', row.id ,row[t.columns[1].key])
        t.close()
      },
      sizeChange(size) {
        const t = this
