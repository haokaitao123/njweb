    ...
    <div class="box">
      <div class="title">
        <div class="title-text">
          <Icon type="mouse" size="16" style="margin-right: 10px;"></Icon>&nbsp;{{$t('lang_evaluation.evaluation.diagnosticScoreResult')}}
        </div>
      ...
      <Row>
        <Col class="col" span="18">
          <div style="height:25px;line-height:25px;">
            <span style="height:25px;display:inline-block;text-align:center">{{$t('lang_evaluation.evaluation.diagproject')}}</span>
            <span style="height:25px;display:inline-block;float:right;width:100px;margin-right:50px;text-align:center">{{$t('lang_evaluation.evaluation.diagscore')}}</span>
            <span style="height:25px;display:inline-block;float:right;width:100px;margin-right:20px;text-align:center">{{$t('lang_evaluation.evaluation.diagscoring')}}</span>
          </div>
...
//        });
              ...
              h("input", {
                ...
                on: {
                  blur: $event => {
                    ...
                    this.toChange(this.data,data.id,$event.target.value)
                  }
                }
              })
            ],
    ...
    toChange(data,id,value){
      let dataList=data
      for(let i=0;i<dataList.length;i++){
        if(dataList[i].id==id){
            dataList[i].proResult=value
          ...
          if(dataList[i].children==undefined){
            ...
            this.toChange(dataList[i].children,id,value)
          }
        }
      }
    },
