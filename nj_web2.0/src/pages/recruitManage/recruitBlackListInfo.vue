    ...
    <div class="box">
      ...
      <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="135">
        ...
        <Row>
          ...
          <FormItem label="求职者姓名" prop="recName">
            <Input v-model="formValidate.recName" :disabled=true placeholder="请输入求职者姓名"></Input>
          </FormItem>
          </Col>
          <Col span="10" offset="1">
          <FormItem label="证件号码" prop="recIdenno">
            <Input v-model="formValidate.recIdenno" :disabled=true placeholder="请输入证件号码"></Input>
          </FormItem>
          </Col>
        </Row>
        <Row>
          <Col span="10" offset="1">
          <FormItem label="手机号" prop="recPhone">
            <Input v-model="formValidate.recPhone" :disabled=true placeholder="请输入手机号"></Input>
          </FormItem>
          </Col>
        </Row>
        <Row>
          ...
          <FormItem label="原因" prop="recReason">
            <Input v-model="formValidate.recReason" :disabled=true type="textarea" :autosize="{minRows: 2,maxRows: 5}" placeholder="请输入原因"></Input>
          </FormItem>
          </Col>
        </Row>
        <Row>
          ...
          <FormItem label="备注" prop="note">
            <Input v-model="formValidate.note" :disabled=true type="textarea" :autosize="{minRows: 2,maxRows: 5}" placeholder="请输入备注"></Input>
          </FormItem>
          </Col>
        </Row>
        <Row>
          ...
          <Row type="flex" justify="end">
            <FormItem>
              ...
              <Button type="primary" @click="handleSubmit"  v-show="!disabled">保存</Button>
            </FormItem>
          </Row>
          </Col>
        </Row>
