<template>
    <div class="cover">
                ...
                <Row class="main-height"
                    ...
                    <Form ref="formValidate"
                        ...
                        <Row>
                            ...
                            <FormItem label="提成比例"
                                      prop="promProp">
                                <Input v-model="formValidate.promProp"
                                       :disabled="disabled"
                                       placeholder="请输入提成比例"></Input>
                            </FormItem>
                            </Col>
                            <Col span="23">
                            <FormItem label="备注"
        ...
        <transition name="fade">
            <searchEmpMaster v-show="openEmpnhName"
                             @closeModal="closeEmpnhName"
                             @inputModal="inputEmpnhName"
                             ref="empnhNameSearch"></searchEmpMaster>
        </transition>
        <transition name="fade">
            <searchEmpMaster v-show="openPromUserName"
                             @closeModal="closePromUserName"
                             @inputModal="inputPromUserName"
                             ref="promUserNameSearch"></searchEmpMaster>
        </transition>
        <!-- <transition name="fade">
      <searchPost
    ...
    methods: {
        ...
        getData (id) {
            ...
            let data = {
                ...
                promUserName: '穆宇',
                promUser: '1000',
                promUserIdno: '610103199002131610',
                promDeptFname: '人力资源',
                promDept: '1000',
                promPostFname: '招聘经理',
                promPost: '1000',
            ...
            t.formValidate.promStart = new Date(data.promStart).format("yyyy-MM-dd");
            t.formValidate.promEnd = new Date(data.promEnd).format("yyyy-MM-dd");
