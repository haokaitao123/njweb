<template>
  <div class="cover">
    <div  class="box">
      ...
      <Row>
        <Button class="lbtn" v-bind:class="{checked: ischecked3}" @click="TransformationMode(3)"><Icon type="clock"></Icon>确认信息</Button>
            ...
            render: (h, params) => {
              return h('div', [
                h('Button', {
                  ...
                  on: {
                    click: () => {
                      this.openUp2(params.row.id, this.$t('button.upd'), params.index, params.row['salpltkDate'])
                    },
                  },
                }, this.$t('button.upd')),
                h('Button', {
