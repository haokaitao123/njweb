      ...
      <card>
        ...
        <Row>
          <span @dblclick="dbHCompany">
               <Input v-model="plsimnpCompanyDis" style="width: 130px" icon="search" :readonly="true"  :placeholder="$t('lang_payroll.payMonPeriod.plsimnpCompanyDis')"  @on-click="selectHCompany"/>
          </span>
          <span @dblclick="clearFyperiod">
               <Input v-model="plsimnpPeriodDis" style="width: 130px" icon="search" :readonly="true"  :placeholder="$t('lang_payroll.payMonPeriod.plsimnpPeriodDis')"  @on-click="pickFyperiod"/>
          </span>
