          ...
          <Form :model="form" label-position="right" ref="form" :label-width="155">
            ...
            <i-col span="11">
              <FormItem :label="$t('lang_payroll.payMonPeriod.plsimnpStatus')" prop="plsimnpStatus">
                <Input v-model="form.plsimnpStatusDis" disabled :placeholder="$t('lang_payroll.payMonPeriod.plsimnpStatusDis')"></Input>
              </FormItem>
            </i-col>
            <i-col span="23">
            ...
            <i-col span="23">
              <FormItem :label="$t('lang_payroll.payMonPeriod.plsimnpComment')" prop="plsimnpComment">
                <Input v-model="form.plsimnpComment" type="textarea" :autosize="{minRows: 2,maxRows: 5}" :placeholder="$t('lang_payroll.payMonPeriod.plsimnpCommentDis')"></Input>
              </FormItem>
            </i-col>
          </Form>
        </Row>
