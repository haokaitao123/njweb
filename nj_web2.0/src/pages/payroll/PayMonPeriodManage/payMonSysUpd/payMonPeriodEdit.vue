      ...
      <div class="option-main">
        <Row style="max-height: 420px;overflow-y: auto;">
          <Form :model="form" label-position="right" ref="form" :label-width="155">
            ...
            <i-col span="11">
              <FormItem :label="$t('lang_payroll.payMonPeriod.plsimnpConfirmer')">
                <Input v-model="form.plsimnpConfirmerDis" disabled :placeholder="$t('lang_payroll.payMonPeriod.plsimnpConfirmerDis')"></Input>
              </FormItem>
            </i-col>
            <i-col span="11" offset="1">
              <FormItem :label="$t('lang_payroll.payMonPeriod.plsimnpConfirmtime')">
                <Input v-model="form.plsimnpConfirmtime" disabled :placeholder="$t('lang_payroll.payMonPeriod.plsimnpConfirmtimeDis')"></Input>
              </FormItem>
            </i-col>
            <i-col span="23">
              <FormItem :label="$t('lang_payroll.payMonPeriod.plsimnpConfirmrecord')" prop="plsimnpConfirmrecord">
                <Input v-model="form.plsimnpConfirmrecord" disabled type="textarea" :autosize="{minRows: 2,maxRows: 5}" :placeholder="$t('lang_payroll.payMonPeriod.plsimnpConfirmrecordDis')"></Input>
              </FormItem>
            </i-col>
            <i-col span="11" v-show="form.plsimnpStatus === '30updated'?true:false">
              <FormItem :label="$t('lang_payroll.payMonPeriod.plsimnpUpdperson')">
                <Input v-model="form.plsimnpUpdpersonDis" disabled :placeholder="$t('lang_payroll.payMonPeriod.plsimnpUpdpersonDis')"></Input>
              </FormItem>
            </i-col>
            <i-col span="11" offset="1" v-show="form.plsimnpStatus === '30updated'?true:false">
              <FormItem :label="$t('lang_payroll.payMonPeriod.plsimnpUpdtime')">
                <Input v-model="form.plsimnpUpdtime" disabled :placeholder="$t('lang_payroll.payMonPeriod.plsimnpUpdtimeDis')"></Input>
              </FormItem>
            </i-col>
            <i-col span="23">
        ...
        <!--<Button class="btn" type="primary" @click="cancel">{{$t('button.clo')}}</Button>-->
      </div>
    </div>
  </div>
</template>
