    ...
    <Row>
      ...
      <card>
        <p slot="title">
          ...
          &nbsp;&nbsp;{{$t('lang_payroll.paySalplan.paySalplanConfirm')}}
        </p>
        <Row>
        ...
        <row class="table-form" ref="table-form">
          <Table @on-select="selectedtable" @on-select-cancel="selectedtable" :current="page" @on-select-all="selectedtable" @on-sort-change="sortable" :height="tableheight" size="small" border ref="selection" :columns="columns" :data="data"></Table>
        </row>
