        ...
        <Form :model="form" label-position="right" :rules="ruleValidate" ref="form" :label-width="110">
          ...
          <i-col span="11">
            <FormItem :label="$t('lang_payroll.payAdjustItem.plajitmAdjust')" prop="plajitmAdjust">
              <RadioGroup v-model="form.plajitmAdjust" disabled :placeholder="$t('lang_payroll.payAdjustItem.plajitmAdjustDis')" >
          ...
          <i-col span="11">
            <FormItem :label="$t('lang_payroll.payAdjustItem.plajitmSpecsdate')" prop="plajitmSpecsdate">
              <Input disabled :placeholder="$t('lang_payroll.payAdjustItem.plajitmSpecsdateDis')" v-model="form.plajitmSpecsdate" ></Input>
            </FormItem>
          </i-col>
          <i-col span="11" offset="1" v-show="form.plajitmAdjust === '1'?true:false">
            <FormItem :label="$t('lang_payroll.payAdjustItem.plajitmAdjamt')" prop="plajitmAdjamt">
              <Input v-model="form.plajitmAdjamt" disabled :placeholder="$t('lang_payroll.payAdjustItem.plajitmAdjamtDis')"></Input>
            </FormItem>
          </i-col>
          <i-col span="23">
            <FormItem :label="$t('lang_payroll.payAdjustItem.plajitmComment')" prop="plajitmComment">
              <Input v-model="form.plajitmComment" disabled type="textarea" :autosize="{minRows: 2,maxRows: 5}" :placeholder="$t('lang_payroll.payAdjustItem.plajitmCommentDis')"></Input>
            </FormItem>
          </i-col>
        </Form>
      </Row>
