    ...
    <Row>
      <Col span="24">
        ...
        <p slot="title">
          ...
          &nbsp;{{$t('lang_payroll.payAdjust.title2')}}
        </p>
        <Row>
    ...
    data() {
      return {
        ...
        columns: [
          ...
          {
            title: this.$t('lang_payroll.payAdjust.plajIsconfirm'),
            key: 'plajIsconfirmDis',
            width: 100,
            fixed: 'right',
            align: 'center',
          },
          ...
          getDataLevelUserLogin(data).then((res) => {
            if (isSuccess(res, t)) {
              ...
              if (t.isInit === 0) {
                ...
                t.$Modal.warning({
                  title: this.$t('reminder.remind'),
                  content: this.$t('lang_payroll.payAdjust.noconfirmRemind'),
                })
              }
            }
          }).catch(() => {
