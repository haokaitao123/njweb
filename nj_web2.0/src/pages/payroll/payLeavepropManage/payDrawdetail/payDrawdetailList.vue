...
import update from "./PayDrawdetailEdit";                    //新增修改组件
...
export default {
    data () {
        return {
            // 导入的mt名称
            imp_mt: "payDrawdetail.importData",
            // 导出的mt名称
            exp_mt: "payDrawdetail.export",
            // 导出字段设置, code字段名 name列名
            expDataTital: [
                    { code: "drawPid", name: "外键" },
    { code: "drawPer", name: "计提期间" },
    { code: "drawAmount", name: "计提金额" },
            ],
            // 表格列字段
            columns: [
            	{ type : "selection" , width: 54 , fixed : "left" , align : "center" },
                    { key: "drawPid", title: "外键", sortable: "custom" , width : 220},
    { key: "drawPer", title: "计提期间", sortable: "custom" , width : 220},
    { key: "drawAmount", title: "计提金额", sortable: "custom" , width : 220},
            ...
            // 表格获取数据mt名称
            page_mt: "payDrawdetail.getPage",
            // 删除数据mt名称
            dele_mt: "payDrawdetail.delByIds",
            // 修改流程状态mt名称
            state_mt: "payDrawdetail.setStateByIds",
            //表格 id
            updateId: NaN,
            //对应列表index
            index: 0,
