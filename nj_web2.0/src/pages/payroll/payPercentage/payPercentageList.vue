<template>
    ...
    @on-click="unitFnamePick" />
					...
					<!-- 表格 分页 -->
					<commonPage :imp_mt="imp_mt" :page_mt="page_mt" :exp_mt="exp_mt" :dele_mt="dele_mt" :state_mt="state_mt" :expDataTital="expDataTital" :table_height="table_height" :mockData="mockData" @tableBtn="tableBtn" ref="commonPage">
					</commonPage>
					</Col>
				</Row>
			</card>
		...
		<!--搜索 弹出选择框  -->
		<transition name="fade">
			<searchOrgframe v-show="openUnitFname" :searchCloumns="searchCloumns2" @closeUp="closeUnitFname" :params="params2" @changeinput="inputUnitFname" ref="searchOrgframe">
			</searchOrgframe>
		</transition>
	</div>
</template>
