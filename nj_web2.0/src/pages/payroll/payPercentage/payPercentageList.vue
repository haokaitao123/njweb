<template>
    ...
    <Input v-model="searchParams.pectStart"
    placeholder="请输入生效时间"
style="width: 200px"/>    <Input v-model="searchParams.pectEnd"
    placeholder="请输入失效时间"
style="width: 200px"/>
                        <!-- 页面按钮 -->
...
import update from "./payPercentageEdit";                    //新增修改组件
...
export default {
    data () {
        return {
            // 导入的mt名称
            imp_mt: "payPercentage.importData",
            // 导出的mt名称
            exp_mt: "payPercentage.export",
            // 导出字段设置, code字段名 name列名
            expDataTital: [
                    { code: "unitFname", name: "项目名称" },
    { code: "pectTypeDis", name: "提成类型" },
    { code: "pectStart", name: "生效时间" },
    { code: "pectEnd", name: "失效时间" },
    { code: "pectStaff", name: "员工比例" },
    { code: "pectPerson", name: "主管比例" },
    { code: "pectManager", name: "经理比例" },
            ],
            // 表格列字段
            columns: [
            	{ type : "selection" , width: 54 , fixed : "left" , align : "center" },
                    { key: "unitFname", title: "项目名称", sortable: "custom" , width : 220},
    { key: "pectTypeDis", title: "提成类型", sortable: "custom" , width : 220},
    { key: "pectStart", title: "生效时间", sortable: "custom" , width : 220},
    { key: "pectEnd", title: "失效时间", sortable: "custom" , width : 220},
    { key: "pectStaff", title: "员工比例", sortable: "custom" , width : 220},
    { key: "pectPerson", title: "主管比例", sortable: "custom" , width : 220},
    { key: "pectManager", title: "经理比例", sortable: "custom" , width : 220},
            ...
            // 删除数据mt名称
            dele_mt: "payPercentage.delByIds",
            // 修改流程状态mt名称
            state_mt: "payPercentage.setStateByIds",
            //表格 id
            updateId: NaN,
            //操作类型
            logType: "",
