    ...
    <div  class="box">
      ...
      <Col span="24">
        ...
        <div v-show="calendarModel1" class="calendar_table">
          <Row>
            <Button type="primary" @click="openUp2(0, $t('button.add'), 1)">{{$t('button.add')}}</Button>
            ...
            <Row class="table_body_box">
              ...
              <div v-else-if="days.calendarComptype === '01workday' || days.calendarLegaltype === '01workday'" class="conbox area bgWhite">
                <div class="day">{{days.calendarDate1}}</div>
                  ...
                  <var v-html="days.taskName" style="white-space:nowrap;display:block;width:95px;text-overflow: ellipsis;white-space: nowrap;overflow:hidden"></var>
