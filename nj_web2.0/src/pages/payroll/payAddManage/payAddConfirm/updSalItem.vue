        ...
        <Form :model="form" label-position="right"  ref="form" :label-width="110">
          ...
          <i-col span="11" offset="1">
            ...
            <span style="width: 100%">
              <Input v-model="form.pladitmItemDis" disabled icon="search" readonly :placeholder="$t('lang_payroll.payAddSalItem.pladitmItemDis')"/>
            </span>
            </FormItem>
          </i-col>
          <i-col span="11">
           <FormItem :label="$t('lang_payroll.payAddSalItem.pladitmCurrency')" prop="pladitmCurrency">
             <Select v-model="form.pladitmCurrency" disabled :placeholder="$t('lang_payroll.payAddSalItem.pladitmCurrencyDis')" >
          ...
          <i-col span="11" offset="1">
            <FormItem :label="$t('lang_payroll.payAddSalItem.pladitmAmount')" prop="pladitmAmount">
              <Input v-model="form.pladitmAmount" disabled :placeholder="$t('lang_payroll.payAddSalItem.pladitmAmountDis')"></Input>
            </FormItem>
          </i-col>
          <i-col span="11">
          ...
          <i-col span="11" offset="1" >
            <FormItem :label="$t('lang_payroll.payAddSalItem.pladitmEdate')" prop="pladitmEdate">
              <Input v-model="form.pladitmEdate" disabled :placeholder="$t('lang_payroll.payAddSalItem.pladitmEdateDis')"></Input>
            </FormItem>
          </i-col>
          <i-col span="23">
            <FormItem :label="$t('lang_payroll.payAddSalItem.pladitmComment')" prop="pladitmComment">
              <Input v-model="form.pladitmComment" type="textarea" disabled :autosize="{minRows: 2,maxRows: 5}" :placeholder="$t('lang_payroll.payAddSalItem.pladitmCommentDis')"></Input>
            </FormItem>
          </i-col>
        </Form>
      </Row>
