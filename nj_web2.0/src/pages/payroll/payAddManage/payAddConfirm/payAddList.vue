    ...
    data() {
      return {
        ...
        columns: [
          ...
          {
            title: this.$t('lang_payroll.payAdd.pladIsconfirm'),
            key: 'pladIsconfirmDis',
            width: 100,
            fixed: 'right',
            align: 'center',
          },
          ...
          getDataLevelUserLogin(data).then((res) => {
            if (isSuccess(res, t)) {
              ...
              if (t.isInit === 0) {
                ...
                t.$Modal.warning({
                  title: this.$t('reminder.remind'),
                  content: this.$t('lang_payroll.payAdd.noconfirmRemind'),
                })
              }
            }
          }).catch(() => {
