      ...
      <Col span="24">
        ...
        <Row>
          ...
          <span @dblclick="dbHCompany">
               <Input v-model="pladCompanyDis" style="width: 160px" icon="search" @on-enter="getData(1)" :readonly="true" :placeholder="$t('lang_payroll.payAdd.pladCompanyDis')"  @on-click="selectHCompany"/>
          </span>
          <span @dblclick="clearDepart">
               <Input v-model="pladDeptDis" style="width: 160px" icon="search" :readonly="true"  @on-enter="getData(1)" :placeholder="$t('lang_payroll.payAdd.pladDeptDis')"  @on-click="pickDepart"/>
          </span>
          ...
          <Button type="primary" v-show="pladStatus === '20toupd'?true:false" @click="handSubmit">{{$t('button.subm')}}</Button>
        </Row>
