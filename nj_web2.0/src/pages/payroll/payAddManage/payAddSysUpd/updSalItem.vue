        ...
        <Form :model="form" label-position="right"  ref="form" :label-width="110">
          ...
          <i-col span="23">
            <FormItem :label="$t('lang_payroll.payAddSalItem.pladitmComment')" prop="pladitmComment">
              <Input v-model="form.pladitmComment" disabled type="textarea" :autosize="{minRows: 2,maxRows: 5}" :placeholder="$t('lang_payroll.payAddSalItem.pladitmCommentDis')"></Input>
            </FormItem>
          </i-col>
        </Form>
      </Row>
