<template>
    ...
    <Input v-model="searchParams.costPer"
    placeholder="请输入期间"
style="width: 200px"/>
                        <!-- 页面按钮 -->
...
export default {
    data () {
        return {
            ...
            expDataTital: [
                    { code: "costPer", name: "期间" },
    { code: "unitFname", name: "项目名称" },
    { code: "costTypeDis", name: "成本类型" },
    { code: "costPays", name: "职能部门工资" },
    { code: "costWater", name: "水电费" },
    { code: "costWorkstat", name: "工位费" },
    { code: "costBusiness", name: "业务费" },
    { code: "costAmounta", name: "费用A" },
    { code: "costAmountb", name: "费用B" },
    { code: "costAmountc", name: "费用C" },
    { code: "costAmountd", name: "费用D" },
    { code: "costAmounte", name: "费用E" },
    { code: "costAmountf", name: "费用F" },
            ],
            // 表格列字段
            columns: [
            	{ type : "selection" , width: 54 , fixed : "left" , align : "center" },
                    { key: "costPer", title: "期间", sortable: "custom" , width : 220},
    { key: "unitFname", title: "项目名称", sortable: "custom" , width : 220},
    { key: "costTypeDis", title: "成本类型", sortable: "custom" , width : 220},
    { key: "costPays", title: "职能部门工资", sortable: "custom" , width : 220},
    { key: "costWater", title: "水电费", sortable: "custom" , width : 220},
    { key: "costWorkstat", title: "工位费", sortable: "custom" , width : 220},
    { key: "costBusiness", title: "业务费", sortable: "custom" , width : 220},
    { key: "costAmounta", title: "费用A", sortable: "custom" , width : 220},
    { key: "costAmountb", title: "费用B", sortable: "custom" , width : 220},
    { key: "costAmountc", title: "费用C", sortable: "custom" , width : 220},
    { key: "costAmountd", title: "费用D", sortable: "custom" , width : 220},
