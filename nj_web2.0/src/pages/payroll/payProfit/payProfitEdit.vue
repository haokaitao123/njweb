...
<Input v-model="formValidate.profPer" :disabled=disabled placeholder="请输入所属期间"></Input>
</FormItem>
</Col>
<Col span="11">
<FormItem label="工资回款" prop="profPays">
<Input v-model="formValidate.profPays" :disabled=disabled placeholder="请输入工资回款"></Input>
</FormItem>
</Col>
<Col span="11" offset="1">
<FormItem label="社保回款" prop="profSses">
<Input v-model="formValidate.profSses" :disabled=disabled placeholder="请输入社保回款"></Input>
</FormItem>
</Col>
<Col span="11">
<FormItem label="公积金回款" prop="profAcfun">
<Input v-model="formValidate.profAcfun" :disabled=disabled placeholder="请输入公积金回款"></Input>
</FormItem>
</Col>
<Col span="11" offset="1">
<FormItem label="服务费回款" prop="profServer">
<Input v-model="formValidate.profServer" :disabled=disabled placeholder="请输入服务费回款"></Input>
</FormItem>
</Col>
<Col span="11">
<FormItem label="税金回款" prop="profTax">
<Input v-model="formValidate.profTax" :disabled=disabled placeholder="请输入税金回款"></Input>
</FormItem>
</Col>
<Col span="11" offset="1">
<FormItem label="工资支出" prop="profPayout">
<Input v-model="formValidate.profPayout" :disabled=disabled placeholder="请输入工资支出"></Input>
</FormItem>
</Col>
<Col span="11">
<FormItem label="社保支出" prop="profSsesout">
<Input v-model="formValidate.profSsesout" :disabled=disabled placeholder="请输入社保支出"></Input>
</FormItem>
</Col>
<Col span="11" offset="1">
<FormItem label="公积金支出" prop="profAcfunout">
<Input v-model="formValidate.profAcfunout" :disabled=disabled placeholder="请输入公积金支出"></Input>
</FormItem>
</Col>
<Col span="11">
