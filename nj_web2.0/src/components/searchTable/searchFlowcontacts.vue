    ...
    <div class="backbox">
      <div class="title">
        <div class="title-text">
          <Icon type="mouse" size="16" style="margin-right: 10px;"></Icon>&nbsp;{{$t('lang_payroll.platAplInfo.seachFlowcontacts')}}
        </div>
    ...
    methods: {
      getData(params, flcontFlowType, flcontFlowId) {
        ...
        if (t.flcontFlowType === '') {
          ...
          t.flcontFlowId = flcontFlowId
        }
        data.flcontFlowType = t.flcontFlowType
        data.flcontFlowId = t.flcontFlowId
