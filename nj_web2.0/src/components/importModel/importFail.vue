    ...
    <div class="box">
      <div class="title">
        <div class="title-text">
          <Icon type="mouse" size="16" style="margin-right: 10px;"></Icon>&nbsp;{{$t('lang_fileOperation.import.impResult')}}
        </div>
      ...
      <Row type="flex" justify="space-between">
        <i-col span="12" style="line-height: 32px;height: 40px;">
          <Button type="ghost" icon="link" @click="dowFile">{{$t('lang_fileOperation.import.downloadFail')}}</Button>
        </i-col>
        <i-col span="12" style="line-height: 32px;height: 40px;">
        </i-col>
        <i-col span="24" style="line-height: 32px;min-height: 40px;max-height: 160px;overflow-y: auto" v-if="file">
