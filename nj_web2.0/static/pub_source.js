var pubsource = {
  ...
  // 以下为测试环境变量配置
  //   pub_getlink: "http://hr.333job.com:8099/api/v1",
  //   pub_getCaptcha: "http://hr.333job.com:8099/api/v1",
  //   pub_pubf_uploadlink: "http://hr.333job.com:9709/upload?groupId=0",
  //   pub_prvf_uploadlink: "http://hr.333job.com:9709/upload?groupId=1",
  //   pub_pubf_downlink: "http://hr.333job.com:8088/",
  //   pub_prvf_downlink: "http://hr.333job.com:9709/file?",
