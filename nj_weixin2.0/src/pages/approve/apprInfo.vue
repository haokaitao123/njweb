<template>
    <div class="appInfo">
        ...
        <group>
            <x-textarea class="textWrite"
                        :max="300"
                        v-model="value"
                        placeholder="请填写审批意见"></x-textarea>
        </group>
