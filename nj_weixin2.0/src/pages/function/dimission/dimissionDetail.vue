        ...
        getData () {
            ...
            getDataLevelUserLogin(data).then((res) => {
                if (isSuccess(res, t)) {
                    ...
                    t.form.dimApplicant = data.dimApplicant ? data.dimApplicant : '';
                    t.form.dimApplydate = data.dimApplydate ? data.dimApplydate : '';
                    t.form.empId = data.empId ? data.empId : '';
                    t.form.empIdno = data.empIdno ? data.empIdno : '';
                    t.form.deptId = data.deptId ? data.deptId : '';
                    t.form.postId = data.postId ? data.postId : '';
                    t.form.dimBuspmp = !data.dimBuspmp ? '' : data.dimBuspmp;
                    t.form.empnhMobile = data.empnhMobile ? data.empnhMobile : '';
                    t.form.empnhSalaccount = data.empnhSalaccount ? data.empnhSalaccount : '';
                    t.form.dimCertifi = data.dimCertifi ? data.dimCertifi : '';
                    t.form.dimPersmail = data.dimPersmail ? data.dimPersmail : '';
                    t.form.dimType = data.dimType ? data.dimType : '';
                    t.form.dimReason = data.dimReason ? data.dimReason : '';
                    t.form.dimLevsqday = data.dimLevsqday ? data.dimLevsqday : '';
                    t.form.dimLevday = data.dimLevday ? data.dimLevday : '';
                    t.form.dimReasonother = data.dimReasonother ? data.dimReasonother : '';
                    // t.form.dimIsreceive = data.dimIsreceive;
                    // t.form.dimReceive = data.dimReceive ? data.dimReceive : '';
                    t.form.note = data.note ? data.note : '';
                    // t.curStep = data.curStep;
                    t.empIdName = data.empIdName ? data.empIdName : '';
                    t.deptIdDis = data.deptIdDis ? data.deptIdDis : '';
                    t.postIdDis = data.postIdDis ? data.postIdDis : '';
                    t.dimApplicantDis = data.dimApplicantDis ? data.dimApplicantDis : '';
